...
"use strict";!function(){var i={youtubeVideoBaseUrl:"//www.youtube.com/embed",youtubeThumbnailBaseUrl:"http://img.youtube.com/vi",vimeoVideoBaseUrl:"//player.vimeo.com/video"};i.appRootPath=window.appRootPath||"example",i.metadataUrl=i.appRootPath+"/dist/data.min.json";var e={};e.config=i,e.dataRequestState="request-not-sent",e.combinedMetadata={},e.collectionMetadata={},e.postData=[],e.fetchData=function(n){var o=new XMLHttpRequest;o.addEventListener("load",function(){console.log("Response status="+o.status+" ("+o.statusText+")"),e.dataRequestState="received-response";try{e.combinedMetadata=JSON.parse(o.response)}catch(n){return e.combinedMetadata={},e.collectionMetadata={},e.postData=[],void console.error("Unable to parse response body as JSON: "+o.response)}e.collectionMetadata=e.combinedMetadata.collectionMetadata,e.postData=e.combinedMetadata.posts,e.postData.forEach(function(n){var o=e.collectionMetadata.baseUrl+"/"+n.id+"/";n.images.forEach(function(n){n.src=o+n.fileName}),n.videos.forEach(function(n){switch(n.videoHost){case"youtube":n.videoSrc=i.youtubeVideoBaseUrl+"/"+n.id+"?enablejsapi=1",n.thumbnailSrc=i.youtubeThumbnailBaseUrl+"/"+n.id+"/default.jpg";break;case"vimeo":n.videoSrc=i.vimeoVideoBaseUrl+"/"+n.id,n.thumbnailSrc=null;break;default:throw new Error("Invalid video host: "+n.videoHost)}}),n.thumbnailSrc=o+e.collectionMetadata.thumbnailName,n.logoSrc=o+e.collectionMetadata.logoName}),n()},!1),o.addEventListener("error",function(){console.error("An error occurred while transferring the data"),e.dataRequestState="error-with-request"},!1),o.addEventListener("abort",function(){console.error("The transfer has been cancelled by the user"),e.dataRequestState="error-with-request"},!1),console.log("Sending request to "+i.metadataUrl),o.open("GET",i.metadataUrl,!0),o.send(),e.dataRequestState="waiting-for-response"},window.app=window.app||{},app.data=e,console.log("data module loaded")}(),function(){var i={};function e(){window.hg.controller.setGridPostData(i.grid,app.data.postData),app.parameters.updateForNewPostData(app.data.postData)}i.grid=null,window.app=window.app||{},app.main=i,window.addEventListener("load",function n(){console.log("onDocumentLoad");window.removeEventListener("load",n);var o=document.getElementById("hex-grid-area");i.grid=window.hg.controller.createNewHexGrid(o,app.data.postData,!1);app.parameters.initDatGui(i.grid);app.data.fetchData(e)},!1),console.log("main module loaded")}(),function(){var n={config:{}};window.app=window.app||{},app.menuPanel=n,console.log("menu-panel module loaded")}(),function(){var e={};e.folders=[{name:"Main",isOpen:!0,createItems:function(n){var o={"Go Home":window.app.parameters.goHome,"Hide Menu":window.app.parameters.hideMenu};n.add(o,"Go Home"),n.add(o,"Hide Menu")},children:[{name:"Pre-Set Configurations",isOpen:!0,createItems:function(o){var i={};Object.keys(e.preSetConfigs).forEach(function(n){i[n]=window.app.parameters.updateToPreSetConfigs.bind(window.app.parameters,e.preSetConfigs[n]),o.add(i,n)})},children:[]},{name:"Filter Posts",isOpen:!0,createItems:function(n){var o={all:i.bind(window.app.parameters,"all"),work:i.bind(window.app.parameters,"work"),research:i.bind(window.app.parameters,"research"),"side-projects":i.bind(window.app.parameters,"side-project")};function i(n){window.app.parameters.categoryData[n].menuItem.setValue(!0)}n.add(o,"all"),n.add(o,"work"),n.add(o,"research"),n.add(o,"side-projects"),window.app.parameters.categoriesFolder=n.addFolder("All Categories")},children:[]}]},{name:"Grid",isOpen:!1,createItems:function(n){var o={};o.backgroundColor=window.hg.util.hslToHsv({h:window.hg.Grid.config.backgroundHue,s:.01*window.hg.Grid.config.backgroundSaturation,l:.01*window.hg.Grid.config.backgroundLightness}),o.tileColor=window.hg.util.hslToHsv({h:window.hg.Grid.config.tileHue,s:.01*window.hg.Grid.config.tileSaturation,l:.01*window.hg.Grid.config.tileLightness}),n.add(a.grid,"isVertical").onChange(function(){window.hg.controller.resetGrid(a.grid)}),n.add(window.hg.Grid.config,"tileOuterRadius",10,400).onChange(function(){window.hg.Grid.config.computeDependentValues(),window.hg.controller.resetGrid(a.grid)}),n.add(window.hg.Grid.config,"tileGap",-50,100).onChange(function(){window.hg.Grid.config.computeDependentValues(),window.hg.controller.resetGrid(a.grid)}),n.addColor(o,"backgroundColor").onChange(function(){var n=window.hg.util.hsvToHsl(o.backgroundColor);window.hg.Grid.config.backgroundHue=n.h,window.hg.Grid.config.backgroundSaturation=100*n.s,window.hg.Grid.config.backgroundLightness=100*n.l,a.grid.setBackgroundColor()}),n.addColor(o,"tileColor").onChange(function(){var n=window.hg.util.hsvToHsl(o.tileColor);window.hg.Grid.config.tileHue=n.h,window.hg.Grid.config.tileSaturation=100*n.s,window.hg.Grid.config.tileLightness=100*n.l,a.grid.updateTileColor(),window.hg.Annotations.config.annotations.contentTiles.enabled&&a.grid.annotations.toggleAnnotationEnabled("contentTiles",!0)}),n.add(window.hg.Grid.config,"firstRowYOffset",-100,100).onChange(function(){window.hg.Grid.config.computeDependentValues(),window.hg.controller.resetGrid(a.grid)}),n.add(window.hg.Grid.config,"contentStartingRowIndex",0,4).step(1).onChange(function(){window.hg.Grid.config.computeDependentValues(),a.grid.computeContentIndices(),window.hg.controller.resetGrid(a.grid)}),n.add(window.hg.Grid.config,"targetContentAreaWidth",500,1500).onChange(function(){window.hg.Grid.config.computeDependentValues(),a.grid.computeContentIndices(),window.hg.controller.resetGrid(a.grid)}),n.add(window.hg.Grid.config,"contentDensity",.1,1).onChange(function(){window.hg.Grid.config.computeDependentValues(),a.grid.computeContentIndices(),window.hg.controller.resetGrid(a.grid)})}},{name:"Annotations",isOpen:!1,createItems:function(n){var o,i;for(o in window.hg.Annotations.config.annotations)(i={})[o]=window.hg.Annotations.config.annotations[o].enabled,n.add(i,o).onChange(function(n){a.grid.annotations.toggleAnnotationEnabled(this.property,n)})}},{name:"Particle System",isOpen:!1,createItems:function(n){n.add(window.hg.Tile.config,"dragCoeff",1e-6,.1),n.add(window.hg.Tile.config,"neighborSpringCoeff",1e-6,1e-4),n.add(window.hg.Tile.config,"neighborDampingCoeff",1e-6,.009999),n.add(window.hg.Tile.config,"innerAnchorSpringCoeff",1e-6,1e-4),n.add(window.hg.Tile.config,"innerAnchorDampingCoeff",1e-6,.009999),n.add(window.hg.Tile.config,"borderAnchorSpringCoeff",1e-6,1e-4),n.add(window.hg.Tile.config,"borderAnchorDampingCoeff",1e-6,.009999),n.add(window.hg.Tile.config,"forceSuppressionLowerThreshold",1e-6,.009999),n.add(window.hg.Tile.config,"velocitySuppressionLowerThreshold",1e-6,.009999),n.add(window.hg.Grid.config,"tileMass",.1,10).onChange(function(n){a.grid.updateTileMass(n)})}},{name:"Input",isOpen:!1,createItems:function(n){n.add(window.hg.Input.config,"contentTileClickAnimation",Object.keys(window.hg.Input.config.possibleClickAnimations)),n.add(window.hg.Input.config,"emptyTileClickAnimation",Object.keys(window.hg.Input.config.possibleClickAnimations))}}],e.defaultPreSet="gold-scale",e.preSetConfigs={},e.preSetConfigs["gold-scale"]={Grid:{tileGap:4,backgroundHue:40,backgroundSaturation:15,backgroundLightness:3,tileHue:45,tileSaturation:10,tileLightness:7},TilePost:{inactiveScreenOpacity:.84,inactiveScreenHue:40,inactiveScreenSaturation:1,inactiveScreenLightness:1},LineJob:{lineWidth:4,startSaturation:100,startLightness:80,startOpacity:.3,endSaturation:100,endLightness:60,endOpacity:0,sameDirectionProb:.6},HighlightRadiateJob:{deltaSaturation:50,deltaLightness:20},HighlightHoverJob:{deltaSaturation:10,deltaLightness:20},ColorWaveJob:{deltaSaturation:20,deltaLightness:14,wavelength:4e3,period:4500,originY:2e3},ColorShiftJob:{hueDeltaMin:0,hueDeltaMax:0,saturationDeltaMin:-10,saturationDeltaMax:8,lightnessDeltaMin:-5,lightnessDeltaMax:5,imageBackgroundScreenOpacityDeltaMin:-.05,imageBackgroundScreenOpacityDeltaMax:.05,transitionDurationMin:800,transitionDurationMax:2e3},DisplacementWaveJob:{period:1e6,tileDeltaX:0,tileDeltaY:0},OpenPostJob:{fadePostDurationOffset:300},ClosePostJob:{duration:200}},e.preSetConfigs["stormy-sea"]={LineJob:{isRecurring:!0}},e.preSetConfigs["color-worms"]={Grid:{tileOuterRadius:50,tileHue:39,tileSaturation:49,tileLightness:12},Tile:{dragCoeff:.02,neighborSpringCoeff:4e-6,innerAnchorSpringCoeff:2e-5,borderAnchorSpringCoeff:2e-5},LineJob:{isRecurring:!0,lineWidth:12,lineLength:400,duration:7e4,lineSidePeriod:1e3,startSaturation:100,startLightness:60,startOpacity:.8,endSaturation:100,endLightness:60,endOpacity:0,sameDirectionProb:.75,avgDelay:2e3,delayDeviationRange:200},LinesRadiateJob:{lineWidth:7,lineLength:250,duration:3e4,lineSidePeriod:120,startSaturation:100,startLightness:60,startOpacity:.8,endSaturation:100,endLightness:60,endOpacity:0,sameDirectionProb:.75},DisplacementWaveJob:{period:1e6,tileDeltaX:0,tileDeltaY:0},ColorWaveJob:{period:1e6,deltaLightness:0},Input:{contentTileClickAnimation:"None",emptyTileClickAnimation:"Radiate Lines"},OpenPostJob:{expandedDisplacementTileCount:4}},e.preSetConfigs["crazy-flux"]={Grid:{tileOuterRadius:60,tileGap:40,tileHue:24,tileSaturation:75,tileLightness:50},LineJob:{isRecurring:!0,lineWidth:100,duration:3e3,startSaturation:100,startLightness:60,startOpacity:.7,endSaturation:100,endLightness:60,endOpacity:0,sameDirectionProb:.25,avgDelay:20,delayDeviationRange:10},Input:{contentTileClickAnimation:"None",emptyTileClickAnimation:"Radiate Lines"},DisplacementWaveJob:{period:1400,tileDeltaX:140,tileDeltaY:-120,originX:2e3,originY:1800},ColorShiftJob:{hueDeltaMin:-180,hueDeltaMax:180}},e.preSetConfigs["wire-frame"]={LineJob:{isRecurring:!0},Annotations:{annotations:{tileNeighborConnections:{enabled:!0},tileAnchorCenters:{enabled:!0},transparentTiles:{enabled:!0},lineAnimationGapPoints:{enabled:!0},lineAnimationCornerData:{enabled:!0},sectorAnchorCenters:{enabled:!0}}},Input:{contentTileClickAnimation:"None",emptyTileClickAnimation:"Radiate Lines"},DisplacementWaveJob:{originX:1600,originY:1800},Tile:{dragCoeff:.013,neighborSpringCoeff:2e-6,innerAnchorSpringCoeff:1e-5,borderAnchorSpringCoeff:2e-5}};var a={};a.init=function(n){a.grid=n},a.config=e,window.app=window.app||{},app.miscParams=a,console.log("miscellaneous-parameters module loaded")}(),function(){var e={},o={},i={};function a(){setTimeout(function(){(window.hg.controller.isSmallScreen?c:l)()},10)}function t(){e.gui=new dat.GUI,e.gui.close(),e.gui.width=o.datGuiWidth,window.gui=e.gui,(window.hg.controller.isSmallScreen?c:l)(),d(o.folders,e.gui)}function d(n,i){n.forEach(function(n){var o;"function"==typeof n?n(i):(o=i.addFolder(n.name),n.folder=o,n.isOpen&&o.open(),n.createItems&&n.createItems(o),n.children&&d(n.children,o))})}function r(n){n.forEach(function(n){"function"!=typeof n&&(n.isOpen=!n.folder.closed,n.children&&r(n.children))})}o.datGuiWidth=300,o.folders=[function(n){d(window.app.miscParams.config.folders,n)},{name:"Animations",isOpen:!1,createItems:null,children:[function(n){d(window.app.transientParams.config.folders,n)},function(n){d(window.app.persistentParams.config.folders,n)}]}],e.config=o,e.initDatGui=function(n){e.grid=n,i=Object.keys(window.hg).reduce(function(n,o){return window.hg[o].config&&(n[o]=window.hg.util.deepCopy(window.hg[o].config)),n},{}),window.app.miscParams.init(n),window.app.persistentParams.init(n),window.app.transientParams.init(n),t(),window.app.parameters.updateToPreSetConfigs.call(window.app.parameters,window.app.miscParams.config.preSetConfigs[window.app.miscParams.config.defaultPreSet]);n=window.hg.util.debounce(a,300);window.addEventListener("resize",n,!1),n()},e.updateForNewPostData=function(n){e.allCategories=function(n){var i=n.reduce(function(n,o){return o.categories.reduce(function(n,o){return n[o]=n[o]?n[o]+1:1,n},n)},{});return Object.keys(i).sort(function(n,o){return i[o]-i[n]})}(n),function(){function o(n,o,i){n[o]={},n[o][o]=!1,n[o].menuItem=i.add(n[o],o).onChange(function(){g(o)})}e.categoryData={},o(e.categoryData,"all",e.categoriesFolder),e.categoryData.all.all=!0,e.allCategories.forEach(function(n){o(e.categoryData,n,e.categoriesFolder)})}()},e.goHome=function(){console.log("Go Home clicked"),window.location.href="/"},e.hideMenu=c,e.updateToPreSetConfigs=function(n){console.log("Updating to pre-set configuration",n),r(o.folders),window.app.parameters.recordOpenChildFolders(window.app.miscParams.config.folders),window.app.parameters.recordOpenChildFolders(window.app.transientParams.config.folders),window.app.parameters.recordOpenChildFolders(window.app.persistentParams.config.folders),Object.keys(window.hg).forEach(function(o){window.hg[o].config&&Object.keys(i[o]).forEach(function(n){window.hg[o].config[n]=window.hg.util.deepCopy(i[o][n])})}),function(i){Object.keys(i).forEach(function(o){Object.keys(i[o]).forEach(function(n){!function o(i,e,a){"object"==typeof e[a]?Object.keys(e[a]).forEach(function(n){o(i[a],e[a],n)}):i[a]=e[a]}(window.hg[o].config,i[o],n)}),window.hg.controller.transientJobs[o]&&window.hg.controller.transientJobs[o].toggleRecurrence&&window.hg.controller.transientJobs[o].toggleRecurrence(e.grid,window.hg[o].config.isRecurring,window.hg[o].config.avgDelay,window.hg[o].config.delayDeviationRange)})}(n),e.grid.annotations.refresh(),window.hg.Grid.config.computeDependentValues(),window.hg.controller.resetGrid(e.grid),e.grid.setBackgroundColor(),e.grid.resize(),e.gui.destroy(),t()},e.filterPosts=g,e.recordOpenChildFolders=r,e.grid=null,e.gui=null,e.categoriesFolder=null,e.allCategories=[],e.categoryData={},window.app=window.app||{},app.parameters=e;var n=0;function g(o){n++,e.categoryData[o][o]?(Object.keys(e.categoryData).forEach(function(n){e.categoryData[n][n]&&n!==o&&e.categoryData[n].menuItem.setValue(!1)}),window.hg.controller.filterGridPostDataByCategory(e.grid,o)):1===n&&e.categoryData.all.menuItem.setValue(!0),n--}function c(){document.querySelector("body > .dg").style.display="none"}function l(){document.querySelector("body > .dg").style.display="block"}console.log("parameters module loaded")}(),function(){var n={folders:[{name:"Persistent",isOpen:!1,createItems:null,children:[{name:"Color Shift",isOpen:!1,createItems:function(n){n.add(window.hg.ColorShiftJob.config,"transitionDurationMin",1,1e4).onChange(function(n){window.hg.ColorShiftJob.config.transitionDurationMax=Math.max(window.hg.ColorShiftJob.config.transitionDurationMin,window.hg.ColorShiftJob.config.transitionDurationMax)}),n.add(window.hg.ColorShiftJob.config,"transitionDurationMax",1,1e4).onChange(function(n){window.hg.ColorShiftJob.config.transitionDurationMin=Math.min(window.hg.ColorShiftJob.config.transitionDurationMin,window.hg.ColorShiftJob.config.transitionDurationMax)}),n.add(window.hg.ColorShiftJob.config,"hueDeltaMin",-360,360).onChange(function(n){window.hg.ColorShiftJob.config.hueDeltaMax=Math.max(window.hg.ColorShiftJob.config.hueDeltaMin,window.hg.ColorShiftJob.config.hueDeltaMax)}),n.add(window.hg.ColorShiftJob.config,"hueDeltaMax",-360,360).onChange(function(n){window.hg.ColorShiftJob.config.hueDeltaMin=Math.min(window.hg.ColorShiftJob.config.hueDeltaMin,window.hg.ColorShiftJob.config.hueDeltaMax)}),n.add(window.hg.ColorShiftJob.config,"saturationDeltaMin",-100,100).onChange(function(n){window.hg.ColorShiftJob.config.saturationDeltaMax=Math.max(window.hg.ColorShiftJob.config.saturationDeltaMin,window.hg.ColorShiftJob.config.saturationDeltaMax)}),n.add(window.hg.ColorShiftJob.config,"saturationDeltaMax",-100,100).onChange(function(n){window.hg.ColorShiftJob.config.saturationDeltaMin=Math.min(window.hg.ColorShiftJob.config.saturationDeltaMin,window.hg.ColorShiftJob.config.saturationDeltaMax)}),n.add(window.hg.ColorShiftJob.config,"lightnessDeltaMin",-100,100).onChange(function(n){window.hg.ColorShiftJob.config.lightnessDeltaMax=Math.max(window.hg.ColorShiftJob.config.lightnessDeltaMin,window.hg.ColorShiftJob.config.lightnessDeltaMax)}),n.add(window.hg.ColorShiftJob.config,"lightnessDeltaMax",-100,100).onChange(function(n){window.hg.ColorShiftJob.config.lightnessDeltaMin=Math.min(window.hg.ColorShiftJob.config.lightnessDeltaMin,window.hg.ColorShiftJob.config.lightnessDeltaMax)}),n.add(window.hg.ColorShiftJob.config,"imageBackgroundScreenOpacityDeltaMin",-1,1).onChange(function(n){window.hg.ColorShiftJob.config.imageBackgroundScreenOpacityDeltaMax=Math.max(window.hg.ColorShiftJob.config.imageBackgroundScreenOpacityDeltaMin,window.hg.ColorShiftJob.config.imageBackgroundScreenOpacityDeltaMax)}),n.add(window.hg.ColorShiftJob.config,"imageBackgroundScreenOpacityDeltaMax",-1,1).onChange(function(n){window.hg.ColorShiftJob.config.imageBackgroundScreenOpacityDeltaMin=Math.min(window.hg.ColorShiftJob.config.imageBackgroundScreenOpacityDeltaMin,window.hg.ColorShiftJob.config.imageBackgroundScreenOpacityDeltaMax)})}},{name:"Color Wave",isOpen:!1,createItems:function(n){n.add(window.hg.ColorWaveJob.config,"period",1,1e4).onChange(function(n){window.hg.ColorWaveJob.config.halfPeriod=n/2}),n.add(window.hg.ColorWaveJob.config,"wavelength",1,4e3).onChange(function(){window.hg.controller.persistentJobs.ColorWaveJob.start(o.grid)}),n.add(window.hg.ColorWaveJob.config,"originX",-500,3e3).onChange(function(){window.hg.controller.persistentJobs.ColorWaveJob.start(o.grid)}),n.add(window.hg.ColorWaveJob.config,"originY",-500,3e3).onChange(function(){window.hg.controller.persistentJobs.ColorWaveJob.start(o.grid)}),n.add(window.hg.ColorWaveJob.config,"deltaHue",0,360),n.add(window.hg.ColorWaveJob.config,"deltaSaturation",0,100),n.add(window.hg.ColorWaveJob.config,"deltaLightness",0,100),n.add(window.hg.ColorWaveJob.config,"opacity",0,1)}},{name:"Displacement Wave",isOpen:!1,createItems:function(n){n.add(window.hg.DisplacementWaveJob.config,"period",1,1e4).onChange(function(n){window.hg.DisplacementWaveJob.config.halfPeriod=n/2}),n.add(window.hg.DisplacementWaveJob.config,"wavelength",1,4e3).onChange(function(){window.hg.controller.persistentJobs.DisplacementWaveJob.start(o.grid)}),n.add(window.hg.DisplacementWaveJob.config,"originX",-500,3e3).onChange(function(){window.hg.controller.persistentJobs.DisplacementWaveJob.start(o.grid)}),n.add(window.hg.DisplacementWaveJob.config,"originY",-500,3e3).onChange(function(){window.hg.controller.persistentJobs.DisplacementWaveJob.start(o.grid)}),n.add(window.hg.DisplacementWaveJob.config,"tileDeltaX",-300,300),n.add(window.hg.DisplacementWaveJob.config,"tileDeltaY",-300,300)}}]}]},o={};o.init=function(n){o.grid=n},o.config=n,window.app=window.app||{},app.persistentParams=o,console.log("persistent-animation-parameters module loaded")}(),function(){var n={folders:[{name:"Transient",isOpen:!1,createItems:null,children:[{name:"Open/Close Post",isOpen:!1,createItems:function(n){var o={triggerOpenPost:window.hg.controller.transientJobs.OpenPostJob.createRandom.bind(window.hg.controller,a.grid),triggerClosePost:window.hg.controller.transientJobs.ClosePostJob.createRandom.bind(window.hg.controller,a.grid,!1),triggerTogglePost:function(){a.grid.isPostOpen?o.triggerClosePost():o.triggerOpenPost()}};n.add(o,"triggerTogglePost"),n.add(window.hg.OpenPostJob.config,"duration",10,1e4).name("Open Duration"),n.add(window.hg.ClosePostJob.config,"duration",10,1e4).name("Close Duration"),n.add(window.hg.OpenPostJob.config,"expandedDisplacementTileCount",0,5).step(1)}},{name:"Displacement Radiate",isOpen:!1,createItems:function(n){var o={triggerDisplacement:window.hg.controller.transientJobs.DisplacementRadiateJob.createRandom.bind(window.hg.controller,a.grid)};function i(){window.hg.controller.transientJobs.DisplacementRadiateJob.toggleRecurrence(a.grid,window.hg.DisplacementRadiateJob.config.isRecurring,window.hg.DisplacementRadiateJob.config.avgDelay,window.hg.DisplacementRadiateJob.config.delayDeviationRange)}n.add(o,"triggerDisplacement"),n.add(window.hg.DisplacementRadiateJob.config,"duration",10,1e4),n.add(window.hg.DisplacementRadiateJob.config,"isRecurring").onChange(i),n.add(window.hg.DisplacementRadiateJob.config,"avgDelay",10,1e4).onChange(i),n.add(window.hg.DisplacementRadiateJob.config,"delayDeviationRange",0,1e4).onChange(i)}},{name:"Hover Highlight",isOpen:!1,createItems:function(n){var o,i;function e(){window.hg.controller.transientJobs.HighlightHoverJob.toggleRecurrence(a.grid,window.hg.HighlightHoverJob.config.isRecurring,window.hg.HighlightHoverJob.config.avgDelay,window.hg.HighlightHoverJob.config.delayDeviationRange)}(i=[]).deltaColor=window.hg.util.hslToHsv({h:window.hg.HighlightHoverJob.config.deltaHue,s:.01*window.hg.HighlightHoverJob.config.deltaSaturation,l:.01*window.hg.HighlightHoverJob.config.deltaLightness}),o={triggerHighlightHover:window.hg.controller.transientJobs.HighlightHoverJob.createRandom.bind(window.hg.controller,a.grid)},n.add(o,"triggerHighlightHover"),n.add(window.hg.HighlightHoverJob.config,"duration",10,1e4),n.addColor(i,"deltaColor").onChange(function(){var n=window.hg.util.hsvToHsl(i.deltaColor);window.hg.HighlightHoverJob.config.deltaHue=n.h,window.hg.HighlightHoverJob.config.deltaSaturation=100*n.s,window.hg.HighlightHoverJob.config.deltaLightness=100*n.l}),n.add(window.hg.HighlightHoverJob.config,"opacity",0,1),n.add(window.hg.HighlightHoverJob.config,"isRecurring").onChange(e),n.add(window.hg.HighlightHoverJob.config,"avgDelay",10,2e3).onChange(e),n.add(window.hg.HighlightHoverJob.config,"delayDeviationRange",0,2e3).onChange(e)}},{name:"Radiating Highlight",isOpen:!1,createItems:function(n){var o,i;function e(){window.hg.controller.transientJobs.HighlightRadiateJob.toggleRecurrence(a.grid,window.hg.HighlightRadiateJob.config.isRecurring,window.hg.HighlightRadiateJob.config.avgDelay,window.hg.HighlightRadiateJob.config.delayDeviationRange)}(i=[]).deltaColor=window.hg.util.hslToHsv({h:window.hg.HighlightRadiateJob.config.deltaHue,s:.01*window.hg.HighlightRadiateJob.config.deltaSaturation,l:.01*window.hg.HighlightRadiateJob.config.deltaLightness}),o={triggerHighlightRadiate:window.hg.controller.transientJobs.HighlightRadiateJob.createRandom.bind(window.hg.controller,a.grid)},n.add(o,"triggerHighlightRadiate"),n.add(window.hg.HighlightRadiateJob.config,"shimmerSpeed",.1,10),n.add(window.hg.HighlightRadiateJob.config,"shimmerWaveWidth",1,2e3),n.add(window.hg.HighlightRadiateJob.config,"duration",10,1e4),n.addColor(i,"deltaColor").onChange(function(){var n=window.hg.util.hsvToHsl(i.deltaColor);window.hg.HighlightRadiateJob.config.deltaHue=n.h,window.hg.HighlightRadiateJob.config.deltaSaturation=100*n.s,window.hg.HighlightRadiateJob.config.deltaLightness=100*n.l}),n.add(window.hg.HighlightRadiateJob.config,"opacity",0,1),n.add(window.hg.HighlightRadiateJob.config,"isRecurring").onChange(e),n.add(window.hg.HighlightRadiateJob.config,"avgDelay",10,1e4).onChange(e),n.add(window.hg.HighlightRadiateJob.config,"delayDeviationRange",0,1e4).onChange(e)}},{name:"Intra-Tile Radiate",isOpen:!1,createItems:function(n){var o={triggerIntraTileRadiate:window.hg.controller.transientJobs.IntraTileRadiateJob.createRandom.bind(window.hg.controller,a.grid)};function i(){window.hg.controller.transientJobs.IntraTileRadiateJob.toggleRecurrence(a.grid,window.hg.IntraTileRadiateJob.config.isRecurring,window.hg.IntraTileRadiateJob.config.avgDelay,window.hg.IntraTileRadiateJob.config.delayDeviationRange)}n.add(o,"triggerIntraTileRadiate"),n.add(window.hg.IntraTileRadiateJob.config,"duration",10,1e4),n.add(window.hg.IntraTileRadiateJob.config,"isRecurring").onChange(i),n.add(window.hg.IntraTileRadiateJob.config,"avgDelay",10,1e4).onChange(i),n.add(window.hg.IntraTileRadiateJob.config,"delayDeviationRange",0,1e4).onChange(i)}},{name:"Random Lines",isOpen:!1,createItems:function(n){var o={triggerLine:window.hg.controller.transientJobs.LineJob.createRandom.bind(window.hg.controller,a.grid)};function i(){window.hg.controller.transientJobs.LineJob.toggleRecurrence(a.grid,window.hg.LineJob.config.isRecurring,window.hg.LineJob.config.avgDelay,window.hg.LineJob.config.delayDeviationRange)}n.add(o,"triggerLine"),n.add(window.hg.LineJob.config,"duration",100,2e4),n.add(window.hg.LineJob.config,"lineWidth",1,100),n.add(window.hg.LineJob.config,"lineLength",10,6e4),n.add(window.hg.LineJob.config,"lineSidePeriod",5,500),n.add(window.hg.LineJob.config,"startSaturation",0,100),n.add(window.hg.LineJob.config,"startLightness",0,100),n.add(window.hg.LineJob.config,"startOpacity",0,1),n.add(window.hg.LineJob.config,"endSaturation",0,100),n.add(window.hg.LineJob.config,"endLightness",0,100),n.add(window.hg.LineJob.config,"endOpacity",0,1),n.add(window.hg.LineJob.config,"sameDirectionProb",0,1),n.add(window.hg.LineJob.config,"isBlurOn"),n.add(window.hg.LineJob.config,"blurStdDeviation",0,80),n.add(window.hg.LineJob.config,"isRecurring").onChange(i),n.add(window.hg.LineJob.config,"avgDelay",10,1e4).onChange(i),n.add(window.hg.LineJob.config,"delayDeviationRange",0,1e4).onChange(i)}},{name:"Radiating Lines",isOpen:!1,createItems:function(n){var o={triggerLinesRadiate:window.hg.controller.transientJobs.LinesRadiateJob.createRandom.bind(window.hg.controller,a.grid)};function i(){window.hg.controller.transientJobs.LinesRadiateJob.toggleRecurrence(a.grid,window.hg.LinesRadiateJob.config.isRecurring,window.hg.LinesRadiateJob.config.avgDelay,window.hg.LinesRadiateJob.config.delayDeviationRange)}n.add(o,"triggerLinesRadiate"),n.add(window.hg.LinesRadiateJob.config,"duration",100,2e4),n.add(window.hg.LinesRadiateJob.config,"lineWidth",1,100),n.add(window.hg.LinesRadiateJob.config,"lineLength",10,6e4),n.add(window.hg.LinesRadiateJob.config,"lineSidePeriod",5,500),n.add(window.hg.LinesRadiateJob.config,"startSaturation",0,100),n.add(window.hg.LinesRadiateJob.config,"startLightness",0,100),n.add(window.hg.LinesRadiateJob.config,"startOpacity",0,1),n.add(window.hg.LinesRadiateJob.config,"endSaturation",0,100),n.add(window.hg.LinesRadiateJob.config,"endLightness",0,100),n.add(window.hg.LinesRadiateJob.config,"endOpacity",0,1),n.add(window.hg.LinesRadiateJob.config,"sameDirectionProb",0,1),n.add(window.hg.LinesRadiateJob.config,"isBlurOn"),n.add(window.hg.LinesRadiateJob.config,"blurStdDeviation",0,80),n.add(window.hg.LinesRadiateJob.config,"isRecurring").onChange(i),n.add(window.hg.LinesRadiateJob.config,"avgDelay",10,1e4).onChange(i),n.add(window.hg.LinesRadiateJob.config,"delayDeviationRange",0,1e4).onChange(i)}},{name:"Pan",isOpen:!1,createItems:function(n){var o={triggerPan:window.hg.controller.transientJobs.PanJob.createRandom.bind(window.hg.controller,a.grid)};function i(){window.hg.controller.transientJobs.PanJob.toggleRecurrence(a.grid,window.hg.PanJob.config.isRecurring,window.hg.PanJob.config.avgDelay,window.hg.PanJob.config.delayDeviationRange)}n.add(o,"triggerPan"),n.add(window.hg.PanJob.config,"duration",10,1e4),n.add(window.hg.PanJob.config,"isRecurring").onChange(i),n.add(window.hg.PanJob.config,"avgDelay",10,1e4).onChange(i),n.add(window.hg.PanJob.config,"delayDeviationRange",0,1e4).onChange(i)}},{name:"Spread",isOpen:!1,createItems:function(n){var o={triggerSpread:window.hg.controller.transientJobs.SpreadJob.createRandom.bind(window.hg.controller,a.grid)};function i(){window.hg.controller.transientJobs.SpreadJob.toggleRecurrence(a.grid,window.hg.SpreadJob.config.isRecurring,window.hg.SpreadJob.config.avgDelay,window.hg.SpreadJob.config.delayDeviationRange)}n.add(o,"triggerSpread"),n.add(window.hg.SpreadJob.config,"duration",10,1e4),n.add(window.hg.SpreadJob.config,"displacementRatio",.01,1),n.add(window.hg.SpreadJob.config,"isRecurring").onChange(i),n.add(window.hg.SpreadJob.config,"avgDelay",10,1e4).onChange(i),n.add(window.hg.SpreadJob.config,"delayDeviationRange",0,1e4).onChange(i)}},{name:"Tile Border",isOpen:!1,createItems:function(n){var o={triggerTileBorder:window.hg.controller.transientJobs.TileBorderJob.createRandom.bind(window.hg.controller,a.grid)};function i(){window.hg.controller.transientJobs.TileBorderJob.toggleRecurrence(a.grid,window.hg.TileBorderJob.config.isRecurring,window.hg.TileBorderJob.config.avgDelay,window.hg.TileBorderJob.config.delayDeviationRange)}n.add(o,"triggerTileBorder"),n.add(window.hg.TileBorderJob.config,"duration",10,1e4),n.add(window.hg.TileBorderJob.config,"isRecurring").onChange(i),n.add(window.hg.TileBorderJob.config,"avgDelay",10,1e4).onChange(i),n.add(window.hg.TileBorderJob.config,"delayDeviationRange",0,1e4).onChange(i)}}]}]},a={};a.init=function(n){a.grid=n},a.config=n,window.app=window.app||{},app.transientParams=a,console.log("transient-animation-parameters module loaded")}();