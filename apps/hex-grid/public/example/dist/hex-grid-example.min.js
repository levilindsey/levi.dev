...
"use strict";!function(){var i={youtubeVideoBaseUrl:"//www.youtube.com/embed",youtubeThumbnailBaseUrl:"http://img.youtube.com/vi",vimeoVideoBaseUrl:"//player.vimeo.com/video"};i.appRootPath=window.appRootPath||"example",i.metadataUrl=i.appRootPath+"/dist/data.min.json";var o={};o.config=i,o.dataRequestState="request-not-sent",o.combinedMetadata={},o.collectionMetadata={},o.postData=[],o.fetchData=function(e){var n=new XMLHttpRequest;n.addEventListener("load",function(){console.log("Response status="+n.status+" ("+n.statusText+")"),o.dataRequestState="received-response";try{o.combinedMetadata=JSON.parse(n.response)}catch(e){return o.combinedMetadata={},o.collectionMetadata={},o.postData=[],void console.error("Unable to parse response body as JSON: "+n.response)}o.collectionMetadata=o.combinedMetadata.collectionMetadata,o.postData=o.combinedMetadata.posts,o.postData.forEach(function(e){var n=o.collectionMetadata.baseUrl+"/"+e.id+"/";e.images.forEach(function(e){e.src=n+e.fileName}),e.videos.forEach(function(e){switch(e.videoHost){case"youtube":e.videoSrc=i.youtubeVideoBaseUrl+"/"+e.id+"?enablejsapi=1",e.thumbnailSrc=i.youtubeThumbnailBaseUrl+"/"+e.id+"/default.jpg";break;case"vimeo":e.videoSrc=i.vimeoVideoBaseUrl+"/"+e.id,e.thumbnailSrc=null;break;default:throw new Error("Invalid video host: "+e.videoHost)}}),e.thumbnailSrc=n+o.collectionMetadata.thumbnailName,e.logoSrc=n+o.collectionMetadata.logoName}),e()},!1),n.addEventListener("error",function(){console.error("An error occurred while transferring the data"),o.dataRequestState="error-with-request"},!1),n.addEventListener("abort",function(){console.error("The transfer has been cancelled by the user"),o.dataRequestState="error-with-request"},!1),console.log("Sending request to "+i.metadataUrl),n.open("GET",i.metadataUrl,!0),n.send(),o.dataRequestState="waiting-for-response"},window.app=window.app||{},app.data=o,console.log("data module loaded")}(),function(){var i={};function o(){window.hg.controller.setGridPostData(i.grid,app.data.postData),app.parameters.updateForNewPostData(app.data.postData)}i.grid=null,window.app=window.app||{},app.main=i,window.addEventListener("load",function e(){console.log("onDocumentLoad");window.removeEventListener("load",e);var n=document.getElementById("hex-grid-area");i.grid=window.hg.controller.createNewHexGrid(n,app.data.postData,!1);app.parameters.initDatGui(i.grid);app.data.fetchData(o)},!1),console.log("main module loaded")}(),function(){var e={config:{}};window.app=window.app||{},app.menuPanel=e,console.log("menu-panel module loaded")}(),function(){var o={};o.folders=[{name:"Main",isOpen:!0,createItems:function(e){var n={"Go Home":window.app.parameters.goHome,"Hide Menu":window.app.parameters.hideMenu};e.add(n,"Go Home"),e.add(n,"Hide Menu")},children:[{name:"Pre-Set Configurations",isOpen:!0,createItems:function(n){var i={};Object.keys(o.preSetConfigs).forEach(function(e){i[e]=window.app.parameters.updateToPreSetConfigs.bind(window.app.parameters,o.preSetConfigs[e]),n.add(i,e)})},children:[]},{name:"Filter Posts",isOpen:!0,createItems:function(e){var n={all:i.bind(window.app.parameters,"all"),work:i.bind(window.app.parameters,"work"),research:i.bind(window.app.parameters,"research"),"side-projects":i.bind(window.app.parameters,"side-project")};function i(e){window.app.parameters.categoryData[e].menuItem.setValue(!0)}e.add(n,"all"),e.add(n,"work"),e.add(n,"research"),e.add(n,"side-projects"),window.app.parameters.categoriesFolder=e.addFolder("All Categories")},children:[]}]},{name:"Grid",isOpen:!1,createItems:function(e){var n={};n.backgroundColor=window.hg.util.hslToHsv({h:window.hg.Grid.config.backgroundHue,s:.01*window.hg.Grid.config.backgroundSaturation,l:.01*window.hg.Grid.config.backgroundLightness}),n.tileColor=window.hg.util.hslToHsv({h:window.hg.Grid.config.tileHue,s:.01*window.hg.Grid.config.tileSaturation,l:.01*window.hg.Grid.config.tileLightness}),e.add(a.grid,"isVertical").onChange(function(){window.hg.controller.resetGrid(a.grid)}),e.add(window.hg.Grid.config,"tileOuterRadius",10,400).onChange(function(){window.hg.Grid.config.computeDependentValues(),window.hg.controller.resetGrid(a.grid)}),e.add(window.hg.Grid.config,"tileGap",-50,100).onChange(function(){window.hg.Grid.config.computeDependentValues(),window.hg.controller.resetGrid(a.grid)}),e.addColor(n,"backgroundColor").onChange(function(){var e=window.hg.util.hsvToHsl(n.backgroundColor);window.hg.Grid.config.backgroundHue=e.h,window.hg.Grid.config.backgroundSaturation=100*e.s,window.hg.Grid.config.backgroundLightness=100*e.l,a.grid.setBackgroundColor()}),e.addColor(n,"tileColor").onChange(function(){var e=window.hg.util.hsvToHsl(n.tileColor);window.hg.Grid.config.tileHue=e.h,window.hg.Grid.config.tileSaturation=100*e.s,window.hg.Grid.config.tileLightness=100*e.l,a.grid.updateTileColor(),window.hg.Annotations.config.annotations.contentTiles.enabled&&a.grid.annotations.toggleAnnotationEnabled("contentTiles",!0)}),e.add(window.hg.Grid.config,"firstRowYOffset",-100,100).onChange(function(){window.hg.Grid.config.computeDependentValues(),window.hg.controller.resetGrid(a.grid)}),e.add(window.hg.Grid.config,"contentStartingRowIndex",0,4).step(1).onChange(function(){window.hg.Grid.config.computeDependentValues(),a.grid.computeContentIndices(),window.hg.controller.resetGrid(a.grid)}),e.add(window.hg.Grid.config,"targetContentAreaWidth",500,1500).onChange(function(){window.hg.Grid.config.computeDependentValues(),a.grid.computeContentIndices(),window.hg.controller.resetGrid(a.grid)}),e.add(window.hg.Grid.config,"contentDensity",.1,1).onChange(function(){window.hg.Grid.config.computeDependentValues(),a.grid.computeContentIndices(),window.hg.controller.resetGrid(a.grid)})}},{name:"Annotations",isOpen:!1,createItems:function(e){var n,i;for(n in window.hg.Annotations.config.annotations)(i={})[n]=window.hg.Annotations.config.annotations[n].enabled,e.add(i,n).onChange(function(e){a.grid.annotations.toggleAnnotationEnabled(this.property,e)})}},{name:"Particle System",isOpen:!1,createItems:function(e){e.add(window.hg.Tile.config,"dragCoeff",1e-6,.1),e.add(window.hg.Tile.config,"neighborSpringCoeff",1e-6,1e-4),e.add(window.hg.Tile.config,"neighborDampingCoeff",1e-6,.009999),e.add(window.hg.Tile.config,"innerAnchorSpringCoeff",1e-6,1e-4),e.add(window.hg.Tile.config,"innerAnchorDampingCoeff",1e-6,.009999),e.add(window.hg.Tile.config,"borderAnchorSpringCoeff",1e-6,1e-4),e.add(window.hg.Tile.config,"borderAnchorDampingCoeff",1e-6,.009999),e.add(window.hg.Tile.config,"forceSuppressionLowerThreshold",1e-6,.009999),e.add(window.hg.Tile.config,"velocitySuppressionLowerThreshold",1e-6,.009999),e.add(window.hg.Grid.config,"tileMass",.1,10).onChange(function(e){a.grid.updateTileMass(e)})}},{name:"Input",isOpen:!1,createItems:function(e){e.add(window.hg.Input.config,"contentTileClickAnimation",Object.keys(window.hg.Input.config.possibleClickAnimations)),e.add(window.hg.Input.config,"emptyTileClickAnimation",Object.keys(window.hg.Input.config.possibleClickAnimations))}}],o.defaultPreSet="raven-scale",o.preSetConfigs={},o.preSetConfigs["raven-scale"]={Grid:{tileOuterRadius:80,tileGap:4,backgroundHue:265,backgroundSaturation:15,backgroundLightness:3,tileHue:270,tileSaturation:10,tileLightness:7},TilePost:{inactiveScreenOpacity:.8,inactiveScreenHue:265,inactiveScreenSaturation:1,inactiveScreenLightness:4},LineJob:{lineWidth:4,startSaturation:100,startLightness:80,startOpacity:.3,endSaturation:100,endLightness:60,endOpacity:0,sameDirectionProb:.6},HighlightRadiateJob:{deltaSaturation:50,deltaLightness:20},HighlightHoverJob:{deltaSaturation:10,deltaLightness:20},ColorWaveJob:{deltaSaturation:20,deltaLightness:14,wavelength:2e3,period:2e3,originY:2e3},DisplacementWaveJob:{period:1e6,tileDeltaX:0,tileDeltaY:0},OpenPostJob:{expandedDisplacementTileCount:3,fadePostDurationOffset:300},ClosePostJob:{duration:200}},o.preSetConfigs["stormy-sea"]={LineJob:{isRecurring:!0}},o.preSetConfigs["color-worms"]={Grid:{tileOuterRadius:50,tileHue:39,tileSaturation:49,tileLightness:12},Tile:{dragCoeff:.02,neighborSpringCoeff:4e-6,innerAnchorSpringCoeff:2e-5,borderAnchorSpringCoeff:2e-5},LineJob:{isRecurring:!0,lineWidth:12,lineLength:400,duration:7e4,lineSidePeriod:1e3,startSaturation:100,startLightness:60,startOpacity:.8,endSaturation:100,endLightness:60,endOpacity:0,sameDirectionProb:.75,avgDelay:2e3,delayDeviationRange:200},LinesRadiateJob:{lineWidth:7,lineLength:250,duration:3e4,lineSidePeriod:120,startSaturation:100,startLightness:60,startOpacity:.8,endSaturation:100,endLightness:60,endOpacity:0,sameDirectionProb:.75},DisplacementWaveJob:{period:1e6,tileDeltaX:0,tileDeltaY:0},ColorWaveJob:{period:1e6,deltaLightness:0},Input:{contentTileClickAnimation:"None",emptyTileClickAnimation:"Radiate Lines"},OpenPostJob:{expandedDisplacementTileCount:4}},o.preSetConfigs["crazy-flux"]={Grid:{tileOuterRadius:60,tileGap:40,tileHue:24,tileSaturation:75,tileLightness:50},LineJob:{isRecurring:!0},Input:{contentTileClickAnimation:"None",emptyTileClickAnimation:"Radiate Lines"},DisplacementWaveJob:{period:1400,tileDeltaX:140,tileDeltaY:-120,originX:2e3,originY:1800}},o.preSetConfigs["wire-frame"]={LineJob:{isRecurring:!0},Annotations:{annotations:{tileNeighborConnections:{enabled:!0},tileAnchorCenters:{enabled:!0},transparentTiles:{enabled:!0},lineAnimationGapPoints:{enabled:!0},lineAnimationCornerData:{enabled:!0},sectorAnchorCenters:{enabled:!0}}},Input:{contentTileClickAnimation:"None",emptyTileClickAnimation:"Radiate Lines"},DisplacementWaveJob:{originX:1600,originY:1800},Tile:{dragCoeff:.013,neighborSpringCoeff:2e-6,innerAnchorSpringCoeff:1e-5,borderAnchorSpringCoeff:2e-5}};var a={};a.init=function(e){a.grid=e},a.config=o,window.app=window.app||{},app.miscParams=a,console.log("miscellaneous-parameters module loaded")}(),function(){var o={},n={},a={};function i(){setTimeout(function(){window.hg.controller.isSmallScreen&&o.gui.close()},10)}function t(){o.gui=new dat.GUI,o.gui.width=n.datGuiWidth,window.gui=o.gui,d(n.folders,o.gui)}function d(e,i){e.forEach(function(e){if("function"==typeof e)e(i);else{var n=i.addFolder(e.name);e.folder=n,e.isOpen&&n.open(),e.createItems&&e.createItems(n),e.children&&d(e.children,n)}})}function r(e){e.forEach(function(e){"function"!=typeof e&&(e.isOpen=!e.folder.closed,e.children&&r(e.children))})}n.datGuiWidth=300,n.folders=[function(e){d(window.app.miscParams.config.folders,e)},{name:"Animations",isOpen:!1,createItems:null,children:[function(e){d(window.app.transientParams.config.folders,e)},function(e){d(window.app.persistentParams.config.folders,e)}]}],o.config=n,o.initDatGui=function(e){o.grid=e,a=Object.keys(window.hg).reduce(function(e,n){return window.hg[n].config&&(e[n]=window.hg.util.deepCopy(window.hg[n].config)),e},{}),window.app.miscParams.init(e),window.app.persistentParams.init(e),window.app.transientParams.init(e),t(),window.app.parameters.updateToPreSetConfigs.call(window.app.parameters,window.app.miscParams.config.preSetConfigs[window.app.miscParams.config.defaultPreSet]);var n=window.hg.util.debounce(i,300);window.addEventListener("resize",n,!1)},o.updateForNewPostData=function(e){o.allCategories=(n=e,i=n.reduce(function(e,n){return n.categories.reduce(function(e,n){return e[n]=e[n]?e[n]+1:1,e},e)},{}),Object.keys(i).sort(function(e,n){return i[n]-i[e]})),function(){function n(e,n,i){e[n]={},e[n][n]=!1,e[n].menuItem=i.add(e[n],n).onChange(function(){g(n)})}o.categoryData={},n(o.categoryData,"all",o.categoriesFolder),o.categoryData.all.all=!0,o.allCategories.forEach(function(e){n(o.categoryData,e,o.categoriesFolder)})}();var n,i},o.goHome=function(){console.log("Go Home clicked"),window.location.href="/"},o.hideMenu=function(){console.log("Hide Menu clicked"),document.querySelector("body > .dg").style.display="none"},o.updateToPreSetConfigs=function(e){console.log("Updating to pre-set configuration",e),r(n.folders),window.app.parameters.recordOpenChildFolders(window.app.miscParams.config.folders),window.app.parameters.recordOpenChildFolders(window.app.transientParams.config.folders),window.app.parameters.recordOpenChildFolders(window.app.persistentParams.config.folders),Object.keys(window.hg).forEach(function(n){window.hg[n].config&&Object.keys(a[n]).forEach(function(e){window.hg[n].config[e]=window.hg.util.deepCopy(a[n][e])})}),i=e,Object.keys(i).forEach(function(n){Object.keys(i[n]).forEach(function(e){!function n(i,o,a){"object"==typeof o[a]?Object.keys(o[a]).forEach(function(e){n(i[a],o[a],e)}):i[a]=o[a]}(window.hg[n].config,i[n],e)}),window.hg.controller.transientJobs[n]&&window.hg.controller.transientJobs[n].toggleRecurrence&&window.hg.controller.transientJobs[n].toggleRecurrence(o.grid,window.hg[n].config.isRecurring,window.hg[n].config.avgDelay,window.hg[n].config.delayDeviationRange)}),o.grid.annotations.refresh(),window.hg.Grid.config.computeDependentValues(),window.hg.controller.resetGrid(o.grid),o.grid.setBackgroundColor(),o.grid.resize(),o.gui.destroy(),t();var i},o.filterPosts=g,o.recordOpenChildFolders=r,o.grid=null,o.gui=null,o.categoriesFolder=null,o.allCategories=[],o.categoryData={},window.app=window.app||{},app.parameters=o;var e=0;function g(n){e++,o.categoryData[n][n]?(Object.keys(o.categoryData).forEach(function(e){o.categoryData[e][e]&&e!==n&&o.categoryData[e].menuItem.setValue(!1)}),window.hg.controller.filterGridPostDataByCategory(o.grid,n)):1===e&&o.categoryData.all.menuItem.setValue(!0),e--}console.log("parameters module loaded")}(),function(){var e={};e.folders=[{name:"Persistent",isOpen:!1,createItems:null,children:[{name:"Color Shift",isOpen:!1,createItems:function(e){}},{name:"Color Wave",isOpen:!1,createItems:function(e){e.add(window.hg.ColorWaveJob.config,"period",1,1e4).onChange(function(e){window.hg.ColorWaveJob.config.halfPeriod=e/2}),e.add(window.hg.ColorWaveJob.config,"wavelength",1,4e3).onChange(function(){window.hg.controller.persistentJobs.ColorWaveJob.start(n.grid)}),e.add(window.hg.ColorWaveJob.config,"originX",-500,3e3).onChange(function(){window.hg.controller.persistentJobs.ColorWaveJob.start(n.grid)}),e.add(window.hg.ColorWaveJob.config,"originY",-500,3e3).onChange(function(){window.hg.controller.persistentJobs.ColorWaveJob.start(n.grid)}),e.add(window.hg.ColorWaveJob.config,"deltaHue",0,360),e.add(window.hg.ColorWaveJob.config,"deltaSaturation",0,100),e.add(window.hg.ColorWaveJob.config,"deltaLightness",0,100),e.add(window.hg.ColorWaveJob.config,"opacity",0,1)}},{name:"Displacement Wave",isOpen:!1,createItems:function(e){e.add(window.hg.DisplacementWaveJob.config,"period",1,1e4).onChange(function(e){window.hg.DisplacementWaveJob.config.halfPeriod=e/2}),e.add(window.hg.DisplacementWaveJob.config,"wavelength",1,4e3).onChange(function(){window.hg.controller.persistentJobs.DisplacementWaveJob.start(n.grid)}),e.add(window.hg.DisplacementWaveJob.config,"originX",-500,3e3).onChange(function(){window.hg.controller.persistentJobs.DisplacementWaveJob.start(n.grid)}),e.add(window.hg.DisplacementWaveJob.config,"originY",-500,3e3).onChange(function(){window.hg.controller.persistentJobs.DisplacementWaveJob.start(n.grid)}),e.add(window.hg.DisplacementWaveJob.config,"tileDeltaX",-300,300),e.add(window.hg.DisplacementWaveJob.config,"tileDeltaY",-300,300)}}]}];var n={};n.init=function(e){n.grid=e},n.config=e,window.app=window.app||{},app.persistentParams=n,console.log("persistent-animation-parameters module loaded")}(),function(){var e={};e.folders=[{name:"Transient",isOpen:!1,createItems:null,children:[{name:"Open/Close Post",isOpen:!1,createItems:function(e){var n={triggerOpenPost:window.hg.controller.transientJobs.OpenPostJob.createRandom.bind(window.hg.controller,a.grid),triggerClosePost:window.hg.controller.transientJobs.ClosePostJob.createRandom.bind(window.hg.controller,a.grid),triggerTogglePost:function(){a.grid.isPostOpen?n.triggerClosePost():n.triggerOpenPost()}};e.add(n,"triggerTogglePost"),e.add(window.hg.OpenPostJob.config,"duration",10,1e4).name("Open Duration"),e.add(window.hg.ClosePostJob.config,"duration",10,1e4).name("Close Duration"),e.add(window.hg.OpenPostJob.config,"expandedDisplacementTileCount",0,5).step(1)}},{name:"Displacement Radiate",isOpen:!1,createItems:function(e){var n={triggerDisplacement:window.hg.controller.transientJobs.DisplacementRadiateJob.createRandom.bind(window.hg.controller,a.grid)};function i(){window.hg.controller.transientJobs.DisplacementRadiateJob.toggleRecurrence(a.grid,window.hg.DisplacementRadiateJob.config.isRecurring,window.hg.DisplacementRadiateJob.config.avgDelay,window.hg.DisplacementRadiateJob.config.delayDeviationRange)}e.add(n,"triggerDisplacement"),e.add(window.hg.DisplacementRadiateJob.config,"duration",10,1e4),e.add(window.hg.DisplacementRadiateJob.config,"isRecurring").onChange(i),e.add(window.hg.DisplacementRadiateJob.config,"avgDelay",10,1e4).onChange(i),e.add(window.hg.DisplacementRadiateJob.config,"delayDeviationRange",0,1e4).onChange(i)}},{name:"Hover Highlight",isOpen:!1,createItems:function(e){var n,i;function o(){window.hg.controller.transientJobs.HighlightHoverJob.toggleRecurrence(a.grid,window.hg.HighlightHoverJob.config.isRecurring,window.hg.HighlightHoverJob.config.avgDelay,window.hg.HighlightHoverJob.config.delayDeviationRange)}(i=[]).deltaColor=window.hg.util.hslToHsv({h:window.hg.HighlightHoverJob.config.deltaHue,s:.01*window.hg.HighlightHoverJob.config.deltaSaturation,l:.01*window.hg.HighlightHoverJob.config.deltaLightness}),n={triggerHighlightHover:window.hg.controller.transientJobs.HighlightHoverJob.createRandom.bind(window.hg.controller,a.grid)},e.add(n,"triggerHighlightHover"),e.add(window.hg.HighlightHoverJob.config,"duration",10,1e4),e.addColor(i,"deltaColor").onChange(function(){var e=window.hg.util.hsvToHsl(i.deltaColor);window.hg.HighlightHoverJob.config.deltaHue=e.h,window.hg.HighlightHoverJob.config.deltaSaturation=100*e.s,window.hg.HighlightHoverJob.config.deltaLightness=100*e.l}),e.add(window.hg.HighlightHoverJob.config,"opacity",0,1),e.add(window.hg.HighlightHoverJob.config,"isRecurring").onChange(o),e.add(window.hg.HighlightHoverJob.config,"avgDelay",10,2e3).onChange(o),e.add(window.hg.HighlightHoverJob.config,"delayDeviationRange",0,2e3).onChange(o)}},{name:"Radiating Highlight",isOpen:!1,createItems:function(e){var n,i;function o(){window.hg.controller.transientJobs.HighlightRadiateJob.toggleRecurrence(a.grid,window.hg.HighlightRadiateJob.config.isRecurring,window.hg.HighlightRadiateJob.config.avgDelay,window.hg.HighlightRadiateJob.config.delayDeviationRange)}(i=[]).deltaColor=window.hg.util.hslToHsv({h:window.hg.HighlightRadiateJob.config.deltaHue,s:.01*window.hg.HighlightRadiateJob.config.deltaSaturation,l:.01*window.hg.HighlightRadiateJob.config.deltaLightness}),n={triggerHighlightRadiate:window.hg.controller.transientJobs.HighlightRadiateJob.createRandom.bind(window.hg.controller,a.grid)},e.add(n,"triggerHighlightRadiate"),e.add(window.hg.HighlightRadiateJob.config,"shimmerSpeed",.1,10),e.add(window.hg.HighlightRadiateJob.config,"shimmerWaveWidth",1,2e3),e.add(window.hg.HighlightRadiateJob.config,"duration",10,1e4),e.addColor(i,"deltaColor").onChange(function(){var e=window.hg.util.hsvToHsl(i.deltaColor);window.hg.HighlightRadiateJob.config.deltaHue=e.h,window.hg.HighlightRadiateJob.config.deltaSaturation=100*e.s,window.hg.HighlightRadiateJob.config.deltaLightness=100*e.l}),e.add(window.hg.HighlightRadiateJob.config,"opacity",0,1),e.add(window.hg.HighlightRadiateJob.config,"isRecurring").onChange(o),e.add(window.hg.HighlightRadiateJob.config,"avgDelay",10,1e4).onChange(o),e.add(window.hg.HighlightRadiateJob.config,"delayDeviationRange",0,1e4).onChange(o)}},{name:"Intra-Tile Radiate",isOpen:!1,createItems:function(e){var n={triggerIntraTileRadiate:window.hg.controller.transientJobs.IntraTileRadiateJob.createRandom.bind(window.hg.controller,a.grid)};function i(){window.hg.controller.transientJobs.IntraTileRadiateJob.toggleRecurrence(a.grid,window.hg.IntraTileRadiateJob.config.isRecurring,window.hg.IntraTileRadiateJob.config.avgDelay,window.hg.IntraTileRadiateJob.config.delayDeviationRange)}e.add(n,"triggerIntraTileRadiate"),e.add(window.hg.IntraTileRadiateJob.config,"duration",10,1e4),e.add(window.hg.IntraTileRadiateJob.config,"isRecurring").onChange(i),e.add(window.hg.IntraTileRadiateJob.config,"avgDelay",10,1e4).onChange(i),e.add(window.hg.IntraTileRadiateJob.config,"delayDeviationRange",0,1e4).onChange(i)}},{name:"Random Lines",isOpen:!1,createItems:function(e){var n={triggerLine:window.hg.controller.transientJobs.LineJob.createRandom.bind(window.hg.controller,a.grid)};function i(){window.hg.controller.transientJobs.LineJob.toggleRecurrence(a.grid,window.hg.LineJob.config.isRecurring,window.hg.LineJob.config.avgDelay,window.hg.LineJob.config.delayDeviationRange)}e.add(n,"triggerLine"),e.add(window.hg.LineJob.config,"duration",100,2e4),e.add(window.hg.LineJob.config,"lineWidth",1,100),e.add(window.hg.LineJob.config,"lineLength",10,6e4),e.add(window.hg.LineJob.config,"lineSidePeriod",5,500),e.add(window.hg.LineJob.config,"startSaturation",0,100),e.add(window.hg.LineJob.config,"startLightness",0,100),e.add(window.hg.LineJob.config,"startOpacity",0,1),e.add(window.hg.LineJob.config,"endSaturation",0,100),e.add(window.hg.LineJob.config,"endLightness",0,100),e.add(window.hg.LineJob.config,"endOpacity",0,1),e.add(window.hg.LineJob.config,"sameDirectionProb",0,1),e.add(window.hg.LineJob.config,"isBlurOn"),e.add(window.hg.LineJob.config,"blurStdDeviation",0,80),e.add(window.hg.LineJob.config,"isRecurring").onChange(i),e.add(window.hg.LineJob.config,"avgDelay",10,1e4).onChange(i),e.add(window.hg.LineJob.config,"delayDeviationRange",0,1e4).onChange(i)}},{name:"Radiating Lines",isOpen:!1,createItems:function(e){var n={triggerLinesRadiate:window.hg.controller.transientJobs.LinesRadiateJob.createRandom.bind(window.hg.controller,a.grid)};function i(){window.hg.controller.transientJobs.LinesRadiateJob.toggleRecurrence(a.grid,window.hg.LinesRadiateJob.config.isRecurring,window.hg.LinesRadiateJob.config.avgDelay,window.hg.LinesRadiateJob.config.delayDeviationRange)}e.add(n,"triggerLinesRadiate"),e.add(window.hg.LinesRadiateJob.config,"duration",100,2e4),e.add(window.hg.LinesRadiateJob.config,"lineWidth",1,100),e.add(window.hg.LinesRadiateJob.config,"lineLength",10,6e4),e.add(window.hg.LinesRadiateJob.config,"lineSidePeriod",5,500),e.add(window.hg.LinesRadiateJob.config,"startSaturation",0,100),e.add(window.hg.LinesRadiateJob.config,"startLightness",0,100),e.add(window.hg.LinesRadiateJob.config,"startOpacity",0,1),e.add(window.hg.LinesRadiateJob.config,"endSaturation",0,100),e.add(window.hg.LinesRadiateJob.config,"endLightness",0,100),e.add(window.hg.LinesRadiateJob.config,"endOpacity",0,1),e.add(window.hg.LinesRadiateJob.config,"sameDirectionProb",0,1),e.add(window.hg.LinesRadiateJob.config,"isBlurOn"),e.add(window.hg.LinesRadiateJob.config,"blurStdDeviation",0,80),e.add(window.hg.LinesRadiateJob.config,"isRecurring").onChange(i),e.add(window.hg.LinesRadiateJob.config,"avgDelay",10,1e4).onChange(i),e.add(window.hg.LinesRadiateJob.config,"delayDeviationRange",0,1e4).onChange(i)}},{name:"Pan",isOpen:!1,createItems:function(e){var n={triggerPan:window.hg.controller.transientJobs.PanJob.createRandom.bind(window.hg.controller,a.grid)};function i(){window.hg.controller.transientJobs.PanJob.toggleRecurrence(a.grid,window.hg.PanJob.config.isRecurring,window.hg.PanJob.config.avgDelay,window.hg.PanJob.config.delayDeviationRange)}e.add(n,"triggerPan"),e.add(window.hg.PanJob.config,"duration",10,1e4),e.add(window.hg.PanJob.config,"isRecurring").onChange(i),e.add(window.hg.PanJob.config,"avgDelay",10,1e4).onChange(i),e.add(window.hg.PanJob.config,"delayDeviationRange",0,1e4).onChange(i)}},{name:"Spread",isOpen:!1,createItems:function(e){var n={triggerSpread:window.hg.controller.transientJobs.SpreadJob.createRandom.bind(window.hg.controller,a.grid)};function i(){window.hg.controller.transientJobs.SpreadJob.toggleRecurrence(a.grid,window.hg.SpreadJob.config.isRecurring,window.hg.SpreadJob.config.avgDelay,window.hg.SpreadJob.config.delayDeviationRange)}e.add(n,"triggerSpread"),e.add(window.hg.SpreadJob.config,"duration",10,1e4),e.add(window.hg.SpreadJob.config,"displacementRatio",.01,1),e.add(window.hg.SpreadJob.config,"isRecurring").onChange(i),e.add(window.hg.SpreadJob.config,"avgDelay",10,1e4).onChange(i),e.add(window.hg.SpreadJob.config,"delayDeviationRange",0,1e4).onChange(i)}},{name:"Tile Border",isOpen:!1,createItems:function(e){var n={triggerTileBorder:window.hg.controller.transientJobs.TileBorderJob.createRandom.bind(window.hg.controller,a.grid)};function i(){window.hg.controller.transientJobs.TileBorderJob.toggleRecurrence(a.grid,window.hg.TileBorderJob.config.isRecurring,window.hg.TileBorderJob.config.avgDelay,window.hg.TileBorderJob.config.delayDeviationRange)}e.add(n,"triggerTileBorder"),e.add(window.hg.TileBorderJob.config,"duration",10,1e4),e.add(window.hg.TileBorderJob.config,"isRecurring").onChange(i),e.add(window.hg.TileBorderJob.config,"avgDelay",10,1e4).onChange(i),e.add(window.hg.TileBorderJob.config,"delayDeviationRange",0,1e4).onChange(i)}}]}];var a={};a.init=function(e){a.grid=e},a.config=e,window.app=window.app||{},app.transientParams=a,console.log("transient-animation-parameters module loaded")}();