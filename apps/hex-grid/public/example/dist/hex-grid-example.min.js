...
"use strict";!function(){var o={youtubeVideoBaseUrl:"//www.youtube.com/embed",youtubeThumbnailBaseUrl:"http://img.youtube.com/vi",vimeoVideoBaseUrl:"//player.vimeo.com/video"};o.appRootPath=window.appRootPath||"example",o.metadataUrl=o.appRootPath+"/dist/data.min.json";var e={};e.config=o,e.dataRequestState="request-not-sent",e.combinedMetadata={},e.collectionMetadata={},e.postData=[],e.fetchData=function(n){var i=new XMLHttpRequest;i.addEventListener("load",function(){console.log("Response status="+i.status+" ("+i.statusText+")"),e.dataRequestState="received-response";try{e.combinedMetadata=JSON.parse(i.response)}catch(n){return e.combinedMetadata={},e.collectionMetadata={},e.postData=[],void console.error("Unable to parse response body as JSON: "+i.response)}e.collectionMetadata=e.combinedMetadata.collectionMetadata,e.postData=e.combinedMetadata.posts,e.postData.forEach(function(n){var i=e.collectionMetadata.baseUrl+"/"+n.id+"/";n.images.forEach(function(n){n.src=i+n.fileName}),n.videos.forEach(function(n){switch(n.videoHost){case"youtube":n.videoSrc=o.youtubeVideoBaseUrl+"/"+n.id+"?enablejsapi=1",n.thumbnailSrc=o.youtubeThumbnailBaseUrl+"/"+n.id+"/default.jpg";break;case"vimeo":n.videoSrc=o.vimeoVideoBaseUrl+"/"+n.id,n.thumbnailSrc=null;break;default:throw new Error("Invalid video host: "+n.videoHost)}}),n.thumbnailSrc=i+e.collectionMetadata.thumbnailName,n.logoSrc=i+e.collectionMetadata.logoName}),n()},!1),i.addEventListener("error",function(){console.error("An error occurred while transferring the data"),e.dataRequestState="error-with-request"},!1),i.addEventListener("abort",function(){console.error("The transfer has been cancelled by the user"),e.dataRequestState="error-with-request"},!1),console.log("Sending request to "+o.metadataUrl),i.open("GET",o.metadataUrl,!0),i.send(),e.dataRequestState="waiting-for-response"},window.app=window.app||{},app.data=e,console.log("data module loaded")}(),function(){var o={};function e(){window.hg.controller.setGridPostData(o.grid,app.data.postData),app.parameters.updateForNewPostData(app.data.postData)}o.grid=null,window.app=window.app||{},app.main=o,window.addEventListener("load",function n(){console.log("onDocumentLoad");window.removeEventListener("load",n);var i=document.getElementById("hex-grid-area");o.grid=window.hg.controller.createNewHexGrid(i,app.data.postData,!1);app.parameters.initDatGui(o.grid);app.data.fetchData(e)},!1),console.log("main module loaded")}(),function(){var n={config:{}};window.app=window.app||{},app.menuPanel=n,console.log("menu-panel module loaded")}(),function(){var e={};e.folders=[{name:"Main",isOpen:!0,createItems:function(n){var i={"Go Home":window.app.parameters.goHome,"Hide Menu":window.app.parameters.hideMenu};n.add(i,"Go Home"),n.add(i,"Hide Menu")},children:[{name:"Pre-Set Configurations",isOpen:!0,createItems:function(i){var o={};Object.keys(e.preSetConfigs).forEach(function(n){o[n]=window.app.parameters.updateToPreSetConfigs.bind(window.app.parameters,e.preSetConfigs[n]),i.add(o,n)})},children:[]},{name:"Filter Posts",isOpen:!0,createItems:function(n){var i={all:o.bind(window.app.parameters,"all"),work:o.bind(window.app.parameters,"work"),research:o.bind(window.app.parameters,"research"),"side-projects":o.bind(window.app.parameters,"side-project")};function o(n){window.app.parameters.categoryData[n].menuItem.setValue(!0)}n.add(i,"all"),n.add(i,"work"),n.add(i,"research"),n.add(i,"side-projects"),window.app.parameters.categoriesFolder=n.addFolder("All Categories")},children:[]}]},{name:"Grid",isOpen:!1,createItems:function(n){var i={};i.backgroundColor=window.hg.util.hslToHsv({h:window.hg.Grid.config.backgroundHue,s:.01*window.hg.Grid.config.backgroundSaturation,l:.01*window.hg.Grid.config.backgroundLightness}),i.tileColor=window.hg.util.hslToHsv({h:window.hg.Grid.config.tileHue,s:.01*window.hg.Grid.config.tileSaturation,l:.01*window.hg.Grid.config.tileLightness}),n.add(a.grid,"isVertical").onChange(function(){window.hg.controller.resetGrid(a.grid)}),n.add(window.hg.Grid.config,"tileOuterRadius",10,400).onChange(function(){window.hg.Grid.config.computeDependentValues(),window.hg.controller.resetGrid(a.grid)}),n.add(window.hg.Grid.config,"tileGap",-50,100).onChange(function(){window.hg.Grid.config.computeDependentValues(),window.hg.controller.resetGrid(a.grid)}),n.addColor(i,"backgroundColor").onChange(function(){var n=window.hg.util.hsvToHsl(i.backgroundColor);window.hg.Grid.config.backgroundHue=n.h,window.hg.Grid.config.backgroundSaturation=100*n.s,window.hg.Grid.config.backgroundLightness=100*n.l,a.grid.setBackgroundColor()}),n.addColor(i,"tileColor").onChange(function(){var n=window.hg.util.hsvToHsl(i.tileColor);window.hg.Grid.config.tileHue=n.h,window.hg.Grid.config.tileSaturation=100*n.s,window.hg.Grid.config.tileLightness=100*n.l,a.grid.updateTileColor(),window.hg.Annotations.config.annotations.contentTiles.enabled&&a.grid.annotations.toggleAnnotationEnabled("contentTiles",!0)}),n.add(window.hg.Grid.config,"firstRowYOffset",-100,100).onChange(function(){window.hg.Grid.config.computeDependentValues(),window.hg.controller.resetGrid(a.grid)}),n.add(window.hg.Grid.config,"contentStartingRowIndex",0,4).step(1).onChange(function(){window.hg.Grid.config.computeDependentValues(),a.grid.computeContentIndices(),window.hg.controller.resetGrid(a.grid)}),n.add(window.hg.Grid.config,"targetContentAreaWidth",500,1500).onChange(function(){window.hg.Grid.config.computeDependentValues(),a.grid.computeContentIndices(),window.hg.controller.resetGrid(a.grid)}),n.add(window.hg.Grid.config,"contentDensity",.1,1).onChange(function(){window.hg.Grid.config.computeDependentValues(),a.grid.computeContentIndices(),window.hg.controller.resetGrid(a.grid)})}},{name:"Annotations",isOpen:!1,createItems:function(n){var i,o;for(i in window.hg.Annotations.config.annotations)(o={})[i]=window.hg.Annotations.config.annotations[i].enabled,n.add(o,i).onChange(function(n){a.grid.annotations.toggleAnnotationEnabled(this.property,n)})}},{name:"Particle System",isOpen:!1,createItems:function(n){n.add(window.hg.Tile.config,"dragCoeff",1e-6,.1),n.add(window.hg.Tile.config,"neighborSpringCoeff",1e-6,1e-4),n.add(window.hg.Tile.config,"neighborDampingCoeff",1e-6,.009999),n.add(window.hg.Tile.config,"innerAnchorSpringCoeff",1e-6,1e-4),n.add(window.hg.Tile.config,"innerAnchorDampingCoeff",1e-6,.009999),n.add(window.hg.Tile.config,"borderAnchorSpringCoeff",1e-6,1e-4),n.add(window.hg.Tile.config,"borderAnchorDampingCoeff",1e-6,.009999),n.add(window.hg.Tile.config,"forceSuppressionLowerThreshold",1e-6,.009999),n.add(window.hg.Tile.config,"velocitySuppressionLowerThreshold",1e-6,.009999),n.add(window.hg.Grid.config,"tileMass",.1,10).onChange(function(n){a.grid.updateTileMass(n)})}},{name:"Input",isOpen:!1,createItems:function(n){n.add(window.hg.Input.config,"contentTileClickAnimation",Object.keys(window.hg.Input.config.possibleClickAnimations)),n.add(window.hg.Input.config,"emptyTileClickAnimation",Object.keys(window.hg.Input.config.possibleClickAnimations))}}],e.defaultPreSet="gold-scale",e.preSetConfigs={},e.preSetConfigs["gold-scale"]={Grid:{tileOuterRadius:80,tileGap:4,backgroundHue:40,backgroundSaturation:15,backgroundLightness:3,tileHue:45,tileSaturation:10,tileLightness:7},TilePost:{inactiveScreenOpacity:.84,inactiveScreenHue:40,inactiveScreenSaturation:1,inactiveScreenLightness:1},LineJob:{lineWidth:4,startSaturation:100,startLightness:80,startOpacity:.3,endSaturation:100,endLightness:60,endOpacity:0,sameDirectionProb:.6},HighlightRadiateJob:{deltaSaturation:50,deltaLightness:20},HighlightHoverJob:{deltaSaturation:10,deltaLightness:20},ColorWaveJob:{deltaSaturation:20,deltaLightness:14,wavelength:4e3,period:4500,originY:2e3},ColorShiftJob:{hueDeltaMin:0,hueDeltaMax:0,saturationDeltaMin:-10,saturationDeltaMax:8,lightnessDeltaMin:-5,lightnessDeltaMax:5,imageBackgroundScreenOpacityDeltaMin:-.05,imageBackgroundScreenOpacityDeltaMax:.05,transitionDurationMin:800,transitionDurationMax:2e3},DisplacementWaveJob:{period:1e6,tileDeltaX:0,tileDeltaY:0},OpenPostJob:{expandedDisplacementTileCount:3,fadePostDurationOffset:300},ClosePostJob:{duration:200}},e.preSetConfigs["stormy-sea"]={LineJob:{isRecurring:!0}},e.preSetConfigs["color-worms"]={Grid:{tileOuterRadius:50,tileHue:39,tileSaturation:49,tileLightness:12},Tile:{dragCoeff:.02,neighborSpringCoeff:4e-6,innerAnchorSpringCoeff:2e-5,borderAnchorSpringCoeff:2e-5},LineJob:{isRecurring:!0,lineWidth:12,lineLength:400,duration:7e4,lineSidePeriod:1e3,startSaturation:100,startLightness:60,startOpacity:.8,endSaturation:100,endLightness:60,endOpacity:0,sameDirectionProb:.75,avgDelay:2e3,delayDeviationRange:200},LinesRadiateJob:{lineWidth:7,lineLength:250,duration:3e4,lineSidePeriod:120,startSaturation:100,startLightness:60,startOpacity:.8,endSaturation:100,endLightness:60,endOpacity:0,sameDirectionProb:.75},DisplacementWaveJob:{period:1e6,tileDeltaX:0,tileDeltaY:0},ColorWaveJob:{period:1e6,deltaLightness:0},Input:{contentTileClickAnimation:"None",emptyTileClickAnimation:"Radiate Lines"},OpenPostJob:{expandedDisplacementTileCount:4}},e.preSetConfigs["crazy-flux"]={Grid:{tileOuterRadius:60,tileGap:40,tileHue:24,tileSaturation:75,tileLightness:50},LineJob:{isRecurring:!0,lineWidth:100,duration:3e3,startSaturation:100,startLightness:60,startOpacity:.7,endSaturation:100,endLightness:60,endOpacity:0,sameDirectionProb:.25,avgDelay:20,delayDeviationRange:10},Input:{contentTileClickAnimation:"None",emptyTileClickAnimation:"Radiate Lines"},DisplacementWaveJob:{period:1400,tileDeltaX:140,tileDeltaY:-120,originX:2e3,originY:1800},ColorShiftJob:{hueDeltaMin:-180,hueDeltaMax:180}},e.preSetConfigs["wire-frame"]={LineJob:{isRecurring:!0},Annotations:{annotations:{tileNeighborConnections:{enabled:!0},tileAnchorCenters:{enabled:!0},transparentTiles:{enabled:!0},lineAnimationGapPoints:{enabled:!0},lineAnimationCornerData:{enabled:!0},sectorAnchorCenters:{enabled:!0}}},Input:{contentTileClickAnimation:"None",emptyTileClickAnimation:"Radiate Lines"},DisplacementWaveJob:{originX:1600,originY:1800},Tile:{dragCoeff:.013,neighborSpringCoeff:2e-6,innerAnchorSpringCoeff:1e-5,borderAnchorSpringCoeff:2e-5}};var a={};a.init=function(n){a.grid=n},a.config=e,window.app=window.app||{},app.miscParams=a,console.log("miscellaneous-parameters module loaded")}(),function(){var e={},i={},a={};function o(){setTimeout(function(){window.hg.controller.isSmallScreen&&e.gui.close()},10)}function t(){e.gui=new dat.GUI,e.gui.width=i.datGuiWidth,window.gui=e.gui,d(i.folders,e.gui)}function d(n,o){n.forEach(function(n){if("function"==typeof n)n(o);else{var i=o.addFolder(n.name);n.folder=i,n.isOpen&&i.open(),n.createItems&&n.createItems(i),n.children&&d(n.children,i)}})}function r(n){n.forEach(function(n){"function"!=typeof n&&(n.isOpen=!n.folder.closed,n.children&&r(n.children))})}i.datGuiWidth=300,i.folders=[function(n){d(window.app.miscParams.config.folders,n)},{name:"Animations",isOpen:!1,createItems:null,children:[function(n){d(window.app.transientParams.config.folders,n)},function(n){d(window.app.persistentParams.config.folders,n)}]}],e.config=i,e.initDatGui=function(n){e.grid=n,a=Object.keys(window.hg).reduce(function(n,i){return window.hg[i].config&&(n[i]=window.hg.util.deepCopy(window.hg[i].config)),n},{}),window.app.miscParams.init(n),window.app.persistentParams.init(n),window.app.transientParams.init(n),t(),window.app.parameters.updateToPreSetConfigs.call(window.app.parameters,window.app.miscParams.config.preSetConfigs[window.app.miscParams.config.defaultPreSet]);var i=window.hg.util.debounce(o,300);window.addEventListener("resize",i,!1),i()},e.updateForNewPostData=function(n){e.allCategories=(i=n,o=i.reduce(function(n,i){return i.categories.reduce(function(n,i){return n[i]=n[i]?n[i]+1:1,n},n)},{}),Object.keys(o).sort(function(n,i){return o[i]-o[n]})),function(){function i(n,i,o){n[i]={},n[i][i]=!1,n[i].menuItem=o.add(n[i],i).onChange(function(){g(i)})}e.categoryData={},i(e.categoryData,"all",e.categoriesFolder),e.categoryData.all.all=!0,e.allCategories.forEach(function(n){i(e.categoryData,n,e.categoriesFolder)})}();var i,o},e.goHome=function(){console.log("Go Home clicked"),window.location.href="/"},e.hideMenu=function(){console.log("Hide Menu clicked"),document.querySelector("body > .dg").style.display="none"},e.updateToPreSetConfigs=function(n){console.log("Updating to pre-set configuration",n),r(i.folders),window.app.parameters.recordOpenChildFolders(window.app.miscParams.config.folders),window.app.parameters.recordOpenChildFolders(window.app.transientParams.config.folders),window.app.parameters.recordOpenChildFolders(window.app.persistentParams.config.folders),Object.keys(window.hg).forEach(function(i){window.hg[i].config&&Object.keys(a[i]).forEach(function(n){window.hg[i].config[n]=window.hg.util.deepCopy(a[i][n])})}),o=n,Object.keys(o).forEach(function(i){Object.keys(o[i]).forEach(function(n){!function i(o,e,a){"object"==typeof e[a]?Object.keys(e[a]).forEach(function(n){i(o[a],e[a],n)}):o[a]=e[a]}(window.hg[i].config,o[i],n)}),window.hg.controller.transientJobs[i]&&window.hg.controller.transientJobs[i].toggleRecurrence&&window.hg.controller.transientJobs[i].toggleRecurrence(e.grid,window.hg[i].config.isRecurring,window.hg[i].config.avgDelay,window.hg[i].config.delayDeviationRange)}),e.grid.annotations.refresh(),window.hg.Grid.config.computeDependentValues(),window.hg.controller.resetGrid(e.grid),e.grid.setBackgroundColor(),e.grid.resize(),e.gui.destroy(),t();var o},e.filterPosts=g,e.recordOpenChildFolders=r,e.grid=null,e.gui=null,e.categoriesFolder=null,e.allCategories=[],e.categoryData={},window.app=window.app||{},app.parameters=e;var n=0;function g(i){n++,e.categoryData[i][i]?(Object.keys(e.categoryData).forEach(function(n){e.categoryData[n][n]&&n!==i&&e.categoryData[n].menuItem.setValue(!1)}),window.hg.controller.filterGridPostDataByCategory(e.grid,i)):1===n&&e.categoryData.all.menuItem.setValue(!0),n--}console.log("parameters module loaded")}(),function(){var n={};n.folders=[{name:"Persistent",isOpen:!1,createItems:null,children:[{name:"Color Shift",isOpen:!1,createItems:function(n){n.add(window.hg.ColorShiftJob.config,"transitionDurationMin",1,1e4).onChange(function(n){window.hg.ColorShiftJob.config.transitionDurationMax=Math.max(window.hg.ColorShiftJob.config.transitionDurationMin,window.hg.ColorShiftJob.config.transitionDurationMax)}),n.add(window.hg.ColorShiftJob.config,"transitionDurationMax",1,1e4).onChange(function(n){window.hg.ColorShiftJob.config.transitionDurationMin=Math.min(window.hg.ColorShiftJob.config.transitionDurationMin,window.hg.ColorShiftJob.config.transitionDurationMax)}),n.add(window.hg.ColorShiftJob.config,"hueDeltaMin",-360,360).onChange(function(n){window.hg.ColorShiftJob.config.hueDeltaMax=Math.max(window.hg.ColorShiftJob.config.hueDeltaMin,window.hg.ColorShiftJob.config.hueDeltaMax)}),n.add(window.hg.ColorShiftJob.config,"hueDeltaMax",-360,360).onChange(function(n){window.hg.ColorShiftJob.config.hueDeltaMin=Math.min(window.hg.ColorShiftJob.config.hueDeltaMin,window.hg.ColorShiftJob.config.hueDeltaMax)}),n.add(window.hg.ColorShiftJob.config,"saturationDeltaMin",-100,100).onChange(function(n){window.hg.ColorShiftJob.config.saturationDeltaMax=Math.max(window.hg.ColorShiftJob.config.saturationDeltaMin,window.hg.ColorShiftJob.config.saturationDeltaMax)}),n.add(window.hg.ColorShiftJob.config,"saturationDeltaMax",-100,100).onChange(function(n){window.hg.ColorShiftJob.config.saturationDeltaMin=Math.min(window.hg.ColorShiftJob.config.saturationDeltaMin,window.hg.ColorShiftJob.config.saturationDeltaMax)}),n.add(window.hg.ColorShiftJob.config,"lightnessDeltaMin",-100,100).onChange(function(n){window.hg.ColorShiftJob.config.lightnessDeltaMax=Math.max(window.hg.ColorShiftJob.config.lightnessDeltaMin,window.hg.ColorShiftJob.config.lightnessDeltaMax)}),n.add(window.hg.ColorShiftJob.config,"lightnessDeltaMax",-100,100).onChange(function(n){window.hg.ColorShiftJob.config.lightnessDeltaMin=Math.min(window.hg.ColorShiftJob.config.lightnessDeltaMin,window.hg.ColorShiftJob.config.lightnessDeltaMax)}),n.add(window.hg.ColorShiftJob.config,"imageBackgroundScreenOpacityDeltaMin",-1,1).onChange(function(n){window.hg.ColorShiftJob.config.imageBackgroundScreenOpacityDeltaMax=Math.max(window.hg.ColorShiftJob.config.imageBackgroundScreenOpacityDeltaMin,window.hg.ColorShiftJob.config.imageBackgroundScreenOpacityDeltaMax)}),n.add(window.hg.ColorShiftJob.config,"imageBackgroundScreenOpacityDeltaMax",-1,1).onChange(function(n){window.hg.ColorShiftJob.config.imageBackgroundScreenOpacityDeltaMin=Math.min(window.hg.ColorShiftJob.config.imageBackgroundScreenOpacityDeltaMin,window.hg.ColorShiftJob.config.imageBackgroundScreenOpacityDeltaMax)})}},{name:"Color Wave",isOpen:!1,createItems:function(n){n.add(window.hg.ColorWaveJob.config,"period",1,1e4).onChange(function(n){window.hg.ColorWaveJob.config.halfPeriod=n/2}),n.add(window.hg.ColorWaveJob.config,"wavelength",1,4e3).onChange(function(){window.hg.controller.persistentJobs.ColorWaveJob.start(i.grid)}),n.add(window.hg.ColorWaveJob.config,"originX",-500,3e3).onChange(function(){window.hg.controller.persistentJobs.ColorWaveJob.start(i.grid)}),n.add(window.hg.ColorWaveJob.config,"originY",-500,3e3).onChange(function(){window.hg.controller.persistentJobs.ColorWaveJob.start(i.grid)}),n.add(window.hg.ColorWaveJob.config,"deltaHue",0,360),n.add(window.hg.ColorWaveJob.config,"deltaSaturation",0,100),n.add(window.hg.ColorWaveJob.config,"deltaLightness",0,100),n.add(window.hg.ColorWaveJob.config,"opacity",0,1)}},{name:"Displacement Wave",isOpen:!1,createItems:function(n){n.add(window.hg.DisplacementWaveJob.config,"period",1,1e4).onChange(function(n){window.hg.DisplacementWaveJob.config.halfPeriod=n/2}),n.add(window.hg.DisplacementWaveJob.config,"wavelength",1,4e3).onChange(function(){window.hg.controller.persistentJobs.DisplacementWaveJob.start(i.grid)}),n.add(window.hg.DisplacementWaveJob.config,"originX",-500,3e3).onChange(function(){window.hg.controller.persistentJobs.DisplacementWaveJob.start(i.grid)}),n.add(window.hg.DisplacementWaveJob.config,"originY",-500,3e3).onChange(function(){window.hg.controller.persistentJobs.DisplacementWaveJob.start(i.grid)}),n.add(window.hg.DisplacementWaveJob.config,"tileDeltaX",-300,300),n.add(window.hg.DisplacementWaveJob.config,"tileDeltaY",-300,300)}}]}];var i={};i.init=function(n){i.grid=n},i.config=n,window.app=window.app||{},app.persistentParams=i,console.log("persistent-animation-parameters module loaded")}(),function(){var n={};n.folders=[{name:"Transient",isOpen:!1,createItems:null,children:[{name:"Open/Close Post",isOpen:!1,createItems:function(n){var i={triggerOpenPost:window.hg.controller.transientJobs.OpenPostJob.createRandom.bind(window.hg.controller,a.grid),triggerClosePost:window.hg.controller.transientJobs.ClosePostJob.createRandom.bind(window.hg.controller,a.grid,!1),triggerTogglePost:function(){a.grid.isPostOpen?i.triggerClosePost():i.triggerOpenPost()}};n.add(i,"triggerTogglePost"),n.add(window.hg.OpenPostJob.config,"duration",10,1e4).name("Open Duration"),n.add(window.hg.ClosePostJob.config,"duration",10,1e4).name("Close Duration"),n.add(window.hg.OpenPostJob.config,"expandedDisplacementTileCount",0,5).step(1)}},{name:"Displacement Radiate",isOpen:!1,createItems:function(n){var i={triggerDisplacement:window.hg.controller.transientJobs.DisplacementRadiateJob.createRandom.bind(window.hg.controller,a.grid)};function o(){window.hg.controller.transientJobs.DisplacementRadiateJob.toggleRecurrence(a.grid,window.hg.DisplacementRadiateJob.config.isRecurring,window.hg.DisplacementRadiateJob.config.avgDelay,window.hg.DisplacementRadiateJob.config.delayDeviationRange)}n.add(i,"triggerDisplacement"),n.add(window.hg.DisplacementRadiateJob.config,"duration",10,1e4),n.add(window.hg.DisplacementRadiateJob.config,"isRecurring").onChange(o),n.add(window.hg.DisplacementRadiateJob.config,"avgDelay",10,1e4).onChange(o),n.add(window.hg.DisplacementRadiateJob.config,"delayDeviationRange",0,1e4).onChange(o)}},{name:"Hover Highlight",isOpen:!1,createItems:function(n){var i,o;function e(){window.hg.controller.transientJobs.HighlightHoverJob.toggleRecurrence(a.grid,window.hg.HighlightHoverJob.config.isRecurring,window.hg.HighlightHoverJob.config.avgDelay,window.hg.HighlightHoverJob.config.delayDeviationRange)}(o=[]).deltaColor=window.hg.util.hslToHsv({h:window.hg.HighlightHoverJob.config.deltaHue,s:.01*window.hg.HighlightHoverJob.config.deltaSaturation,l:.01*window.hg.HighlightHoverJob.config.deltaLightness}),i={triggerHighlightHover:window.hg.controller.transientJobs.HighlightHoverJob.createRandom.bind(window.hg.controller,a.grid)},n.add(i,"triggerHighlightHover"),n.add(window.hg.HighlightHoverJob.config,"duration",10,1e4),n.addColor(o,"deltaColor").onChange(function(){var n=window.hg.util.hsvToHsl(o.deltaColor);window.hg.HighlightHoverJob.config.deltaHue=n.h,window.hg.HighlightHoverJob.config.deltaSaturation=100*n.s,window.hg.HighlightHoverJob.config.deltaLightness=100*n.l}),n.add(window.hg.HighlightHoverJob.config,"opacity",0,1),n.add(window.hg.HighlightHoverJob.config,"isRecurring").onChange(e),n.add(window.hg.HighlightHoverJob.config,"avgDelay",10,2e3).onChange(e),n.add(window.hg.HighlightHoverJob.config,"delayDeviationRange",0,2e3).onChange(e)}},{name:"Radiating Highlight",isOpen:!1,createItems:function(n){var i,o;function e(){window.hg.controller.transientJobs.HighlightRadiateJob.toggleRecurrence(a.grid,window.hg.HighlightRadiateJob.config.isRecurring,window.hg.HighlightRadiateJob.config.avgDelay,window.hg.HighlightRadiateJob.config.delayDeviationRange)}(o=[]).deltaColor=window.hg.util.hslToHsv({h:window.hg.HighlightRadiateJob.config.deltaHue,s:.01*window.hg.HighlightRadiateJob.config.deltaSaturation,l:.01*window.hg.HighlightRadiateJob.config.deltaLightness}),i={triggerHighlightRadiate:window.hg.controller.transientJobs.HighlightRadiateJob.createRandom.bind(window.hg.controller,a.grid)},n.add(i,"triggerHighlightRadiate"),n.add(window.hg.HighlightRadiateJob.config,"shimmerSpeed",.1,10),n.add(window.hg.HighlightRadiateJob.config,"shimmerWaveWidth",1,2e3),n.add(window.hg.HighlightRadiateJob.config,"duration",10,1e4),n.addColor(o,"deltaColor").onChange(function(){var n=window.hg.util.hsvToHsl(o.deltaColor);window.hg.HighlightRadiateJob.config.deltaHue=n.h,window.hg.HighlightRadiateJob.config.deltaSaturation=100*n.s,window.hg.HighlightRadiateJob.config.deltaLightness=100*n.l}),n.add(window.hg.HighlightRadiateJob.config,"opacity",0,1),n.add(window.hg.HighlightRadiateJob.config,"isRecurring").onChange(e),n.add(window.hg.HighlightRadiateJob.config,"avgDelay",10,1e4).onChange(e),n.add(window.hg.HighlightRadiateJob.config,"delayDeviationRange",0,1e4).onChange(e)}},{name:"Intra-Tile Radiate",isOpen:!1,createItems:function(n){var i={triggerIntraTileRadiate:window.hg.controller.transientJobs.IntraTileRadiateJob.createRandom.bind(window.hg.controller,a.grid)};function o(){window.hg.controller.transientJobs.IntraTileRadiateJob.toggleRecurrence(a.grid,window.hg.IntraTileRadiateJob.config.isRecurring,window.hg.IntraTileRadiateJob.config.avgDelay,window.hg.IntraTileRadiateJob.config.delayDeviationRange)}n.add(i,"triggerIntraTileRadiate"),n.add(window.hg.IntraTileRadiateJob.config,"duration",10,1e4),n.add(window.hg.IntraTileRadiateJob.config,"isRecurring").onChange(o),n.add(window.hg.IntraTileRadiateJob.config,"avgDelay",10,1e4).onChange(o),n.add(window.hg.IntraTileRadiateJob.config,"delayDeviationRange",0,1e4).onChange(o)}},{name:"Random Lines",isOpen:!1,createItems:function(n){var i={triggerLine:window.hg.controller.transientJobs.LineJob.createRandom.bind(window.hg.controller,a.grid)};function o(){window.hg.controller.transientJobs.LineJob.toggleRecurrence(a.grid,window.hg.LineJob.config.isRecurring,window.hg.LineJob.config.avgDelay,window.hg.LineJob.config.delayDeviationRange)}n.add(i,"triggerLine"),n.add(window.hg.LineJob.config,"duration",100,2e4),n.add(window.hg.LineJob.config,"lineWidth",1,100),n.add(window.hg.LineJob.config,"lineLength",10,6e4),n.add(window.hg.LineJob.config,"lineSidePeriod",5,500),n.add(window.hg.LineJob.config,"startSaturation",0,100),n.add(window.hg.LineJob.config,"startLightness",0,100),n.add(window.hg.LineJob.config,"startOpacity",0,1),n.add(window.hg.LineJob.config,"endSaturation",0,100),n.add(window.hg.LineJob.config,"endLightness",0,100),n.add(window.hg.LineJob.config,"endOpacity",0,1),n.add(window.hg.LineJob.config,"sameDirectionProb",0,1),n.add(window.hg.LineJob.config,"isBlurOn"),n.add(window.hg.LineJob.config,"blurStdDeviation",0,80),n.add(window.hg.LineJob.config,"isRecurring").onChange(o),n.add(window.hg.LineJob.config,"avgDelay",10,1e4).onChange(o),n.add(window.hg.LineJob.config,"delayDeviationRange",0,1e4).onChange(o)}},{name:"Radiating Lines",isOpen:!1,createItems:function(n){var i={triggerLinesRadiate:window.hg.controller.transientJobs.LinesRadiateJob.createRandom.bind(window.hg.controller,a.grid)};function o(){window.hg.controller.transientJobs.LinesRadiateJob.toggleRecurrence(a.grid,window.hg.LinesRadiateJob.config.isRecurring,window.hg.LinesRadiateJob.config.avgDelay,window.hg.LinesRadiateJob.config.delayDeviationRange)}n.add(i,"triggerLinesRadiate"),n.add(window.hg.LinesRadiateJob.config,"duration",100,2e4),n.add(window.hg.LinesRadiateJob.config,"lineWidth",1,100),n.add(window.hg.LinesRadiateJob.config,"lineLength",10,6e4),n.add(window.hg.LinesRadiateJob.config,"lineSidePeriod",5,500),n.add(window.hg.LinesRadiateJob.config,"startSaturation",0,100),n.add(window.hg.LinesRadiateJob.config,"startLightness",0,100),n.add(window.hg.LinesRadiateJob.config,"startOpacity",0,1),n.add(window.hg.LinesRadiateJob.config,"endSaturation",0,100),n.add(window.hg.LinesRadiateJob.config,"endLightness",0,100),n.add(window.hg.LinesRadiateJob.config,"endOpacity",0,1),n.add(window.hg.LinesRadiateJob.config,"sameDirectionProb",0,1),n.add(window.hg.LinesRadiateJob.config,"isBlurOn"),n.add(window.hg.LinesRadiateJob.config,"blurStdDeviation",0,80),n.add(window.hg.LinesRadiateJob.config,"isRecurring").onChange(o),n.add(window.hg.LinesRadiateJob.config,"avgDelay",10,1e4).onChange(o),n.add(window.hg.LinesRadiateJob.config,"delayDeviationRange",0,1e4).onChange(o)}},{name:"Pan",isOpen:!1,createItems:function(n){var i={triggerPan:window.hg.controller.transientJobs.PanJob.createRandom.bind(window.hg.controller,a.grid)};function o(){window.hg.controller.transientJobs.PanJob.toggleRecurrence(a.grid,window.hg.PanJob.config.isRecurring,window.hg.PanJob.config.avgDelay,window.hg.PanJob.config.delayDeviationRange)}n.add(i,"triggerPan"),n.add(window.hg.PanJob.config,"duration",10,1e4),n.add(window.hg.PanJob.config,"isRecurring").onChange(o),n.add(window.hg.PanJob.config,"avgDelay",10,1e4).onChange(o),n.add(window.hg.PanJob.config,"delayDeviationRange",0,1e4).onChange(o)}},{name:"Spread",isOpen:!1,createItems:function(n){var i={triggerSpread:window.hg.controller.transientJobs.SpreadJob.createRandom.bind(window.hg.controller,a.grid)};function o(){window.hg.controller.transientJobs.SpreadJob.toggleRecurrence(a.grid,window.hg.SpreadJob.config.isRecurring,window.hg.SpreadJob.config.avgDelay,window.hg.SpreadJob.config.delayDeviationRange)}n.add(i,"triggerSpread"),n.add(window.hg.SpreadJob.config,"duration",10,1e4),n.add(window.hg.SpreadJob.config,"displacementRatio",.01,1),n.add(window.hg.SpreadJob.config,"isRecurring").onChange(o),n.add(window.hg.SpreadJob.config,"avgDelay",10,1e4).onChange(o),n.add(window.hg.SpreadJob.config,"delayDeviationRange",0,1e4).onChange(o)}},{name:"Tile Border",isOpen:!1,createItems:function(n){var i={triggerTileBorder:window.hg.controller.transientJobs.TileBorderJob.createRandom.bind(window.hg.controller,a.grid)};function o(){window.hg.controller.transientJobs.TileBorderJob.toggleRecurrence(a.grid,window.hg.TileBorderJob.config.isRecurring,window.hg.TileBorderJob.config.avgDelay,window.hg.TileBorderJob.config.delayDeviationRange)}n.add(i,"triggerTileBorder"),n.add(window.hg.TileBorderJob.config,"duration",10,1e4),n.add(window.hg.TileBorderJob.config,"isRecurring").onChange(o),n.add(window.hg.TileBorderJob.config,"avgDelay",10,1e4).onChange(o),n.add(window.hg.TileBorderJob.config,"delayDeviationRange",0,1e4).onChange(o)}}]}];var a={};a.init=function(n){a.grid=n},a.config=n,window.app=window.app||{},app.transientParams=a,console.log("transient-animation-parameters module loaded")}();