...
"use strict";!function(){var e={youtubeVideoBaseUrl:"//www.youtube.com/embed",youtubeThumbnailBaseUrl:"http://img.youtube.com/vi",vimeoVideoBaseUrl:"//player.vimeo.com/video"};e.appRootPath=window.appRootPath||"example",e.metadataUrl=e.appRootPath+"/dist/data.min.json";var i={};i.config=e,i.dataRequestState="request-not-sent",i.combinedMetadata={},i.collectionMetadata={},i.postData=[],i.fetchData=function(o){var n=new XMLHttpRequest;n.addEventListener("load",function(){console.log("Response status="+n.status+" ("+n.statusText+")"),i.dataRequestState="received-response";try{i.combinedMetadata=JSON.parse(n.response)}catch(o){return i.combinedMetadata={},i.collectionMetadata={},i.postData=[],void console.error("Unable to parse response body as JSON: "+n.response)}i.collectionMetadata=i.combinedMetadata.collectionMetadata,i.postData=i.combinedMetadata.posts,i.postData.forEach(function(o){var n=i.collectionMetadata.baseUrl+"/"+o.id+"/";o.images.forEach(function(o){o.src=n+o.fileName}),o.videos.forEach(function(o){switch(o.videoHost){case"youtube":o.videoSrc=e.youtubeVideoBaseUrl+"/"+o.id+"?enablejsapi=1",o.thumbnailSrc=e.youtubeThumbnailBaseUrl+"/"+o.id+"/default.jpg";break;case"vimeo":o.videoSrc=e.vimeoVideoBaseUrl+"/"+o.id,o.thumbnailSrc=null;break;default:throw new Error("Invalid video host: "+o.videoHost)}}),o.thumbnailSrc=n+i.collectionMetadata.thumbnailName,o.logoSrc=n+i.collectionMetadata.logoName}),o()},!1),n.addEventListener("error",function(){console.error("An error occurred while transferring the data"),i.dataRequestState="error-with-request"},!1),n.addEventListener("abort",function(){console.error("The transfer has been cancelled by the user"),i.dataRequestState="error-with-request"},!1),console.log("Sending request to "+e.metadataUrl),n.open("GET",e.metadataUrl,!0),n.send(),i.dataRequestState="waiting-for-response"},window.app=window.app||{},app.data=i,console.log("data module loaded")}(),function(){window.jsKonamiCode={},window.jsKonamiCode.callback=function(){console.log(""),console.log("REST 30"),console.log("");const o=document.querySelector("#konami-code-confirmation-sound");o.volume=.08,o.play()},window.jsKonamiCode.keyDelayThresholdMs=700,window.jsKonamiCode.konamiCodeSequence=["ArrowUp","ArrowUp","ArrowDown","ArrowDown","ArrowLeft","ArrowRight","ArrowLeft","ArrowRight","KeyB","KeyA"];const i={ArrowUp:{code:"ArrowUp",key:"ArrowUp"},ArrowDown:{code:"ArrowDown",key:"ArrowDown"},ArrowLeft:{code:"ArrowLeft",key:"ArrowLeft"},ArrowRight:{code:"ArrowRight",key:"ArrowRight"},KeyW:{code:"KeyW",key:"w"},KeyS:{code:"KeyS",key:"s"},KeyA:{code:"KeyA",key:"a"},KeyD:{code:"KeyD",key:"d"},KeyB:{code:"KeyB",key:"b"}};let e=-window.jsKonamiCode.keyDelayThresholdMs,a=[],t=[];function o(o){var n=e;e=Date.now(),e>=n+window.jsKonamiCode.keyDelayThresholdMs&&(a=[],t=[]),a.push(o.code),t.push(o.key),function(){var n=window.jsKonamiCode.konamiCodeSequence;if(a.length<n)return!1;let e=!0;for(let o=0;o<n.length;o++)if(a[a.length-1-o]!==n[n.length-1-o]){e=!1;break}if(e)return!0;e=!0;for(let o=0;o<n.length;o++)if(t[t.length-1-o].toLowerCase()!==i[n[n.length-1-o]].key.toLowerCase()){e=!1;break}return e}()&&window.jsKonamiCode.callback()}window.addEventListener("load",function(){document.addEventListener("keydown",o,!1)},!1)}(),function(){var e={};function i(){window.hg.controller.setGridPostData(e.grid,app.data.postData),app.parameters.updateForNewPostData(app.data.postData)}e.grid=null,window.app=window.app||{},app.main=e,window.addEventListener("load",function o(){console.log("onDocumentLoad");window.removeEventListener("load",o);var n=document.getElementById("hex-grid-area");e.grid=window.hg.controller.createNewHexGrid(n,app.data.postData,!1);app.parameters.initDatGui(e.grid);app.data.fetchData(i)},!1),console.log("main module loaded")}(),function(){var o={config:{}};window.app=window.app||{},app.menuPanel=o,console.log("menu-panel module loaded")}(),function(){var i={};i.folders=[{name:"Main",isOpen:!0,createItems:function(o){var n={"Go Home":window.app.parameters.goHome,"Hide Menu":window.app.parameters.hideMenu};o.add(n,"Go Home"),o.add(n,"Hide Menu")},children:[{name:"Pre-Set Configurations",isOpen:!0,createItems:function(n){var e={};Object.keys(i.preSetConfigs).forEach(function(o){e[o]=window.app.parameters.updateToPreSetConfigs.bind(window.app.parameters,i.preSetConfigs[o]),n.add(e,o)})},children:[]},{name:"Filter Posts",isOpen:!0,createItems:function(o){var n={all:e.bind(window.app.parameters,"all"),work:e.bind(window.app.parameters,"work"),research:e.bind(window.app.parameters,"research"),"side-projects":e.bind(window.app.parameters,"side-project")};function e(o){window.app.parameters.categoryData[o].menuItem.setValue(!0)}o.add(n,"all"),o.add(n,"work"),o.add(n,"research"),o.add(n,"side-projects"),window.app.parameters.categoriesFolder=o.addFolder("All Categories")},children:[]}]},{name:"Grid",isOpen:!1,createItems:function(o){var n={};n.backgroundColor=window.hg.util.hslToHsv({h:window.hg.Grid.config.backgroundHue,s:.01*window.hg.Grid.config.backgroundSaturation,l:.01*window.hg.Grid.config.backgroundLightness}),n.tileColor=window.hg.util.hslToHsv({h:window.hg.Grid.config.tileHue,s:.01*window.hg.Grid.config.tileSaturation,l:.01*window.hg.Grid.config.tileLightness}),o.add(a.grid,"isVertical").onChange(function(){window.hg.controller.resetGrid(a.grid)}),o.add(window.hg.Grid.config,"tileOuterRadius",10,400).onChange(function(){window.hg.Grid.config.computeDependentValues(),window.hg.controller.resetGrid(a.grid)}),o.add(window.hg.Grid.config,"tileGap",-50,100).onChange(function(){window.hg.Grid.config.computeDependentValues(),window.hg.controller.resetGrid(a.grid)}),o.addColor(n,"backgroundColor").onChange(function(){var o=window.hg.util.hsvToHsl(n.backgroundColor);window.hg.Grid.config.backgroundHue=o.h,window.hg.Grid.config.backgroundSaturation=100*o.s,window.hg.Grid.config.backgroundLightness=100*o.l,a.grid.setBackgroundColor()}),o.addColor(n,"tileColor").onChange(function(){var o=window.hg.util.hsvToHsl(n.tileColor);window.hg.Grid.config.tileHue=o.h,window.hg.Grid.config.tileSaturation=100*o.s,window.hg.Grid.config.tileLightness=100*o.l,a.grid.updateTileColor(),window.hg.Annotations.config.annotations.contentTiles.enabled&&a.grid.annotations.toggleAnnotationEnabled("contentTiles",!0)}),o.add(window.hg.Grid.config,"firstRowYOffset",-100,100).onChange(function(){window.hg.Grid.config.computeDependentValues(),window.hg.controller.resetGrid(a.grid)}),o.add(window.hg.Grid.config,"contentStartingRowIndex",0,4).step(1).onChange(function(){window.hg.Grid.config.computeDependentValues(),a.grid.computeContentIndices(),window.hg.controller.resetGrid(a.grid)}),o.add(window.hg.Grid.config,"targetContentAreaWidth",500,1500).onChange(function(){window.hg.Grid.config.computeDependentValues(),a.grid.computeContentIndices(),window.hg.controller.resetGrid(a.grid)}),o.add(window.hg.Grid.config,"contentDensity",.1,1).onChange(function(){window.hg.Grid.config.computeDependentValues(),a.grid.computeContentIndices(),window.hg.controller.resetGrid(a.grid)})}},{name:"Annotations",isOpen:!1,createItems:function(o){var n,e;for(n in window.hg.Annotations.config.annotations)(e={})[n]=window.hg.Annotations.config.annotations[n].enabled,o.add(e,n).onChange(function(o){a.grid.annotations.toggleAnnotationEnabled(this.property,o)})}},{name:"Particle System",isOpen:!1,createItems:function(o){o.add(window.hg.Tile.config,"dragCoeff",1e-6,.1),o.add(window.hg.Tile.config,"neighborSpringCoeff",1e-6,1e-4),o.add(window.hg.Tile.config,"neighborDampingCoeff",1e-6,.009999),o.add(window.hg.Tile.config,"innerAnchorSpringCoeff",1e-6,1e-4),o.add(window.hg.Tile.config,"innerAnchorDampingCoeff",1e-6,.009999),o.add(window.hg.Tile.config,"borderAnchorSpringCoeff",1e-6,1e-4),o.add(window.hg.Tile.config,"borderAnchorDampingCoeff",1e-6,.009999),o.add(window.hg.Tile.config,"forceSuppressionLowerThreshold",1e-6,.009999),o.add(window.hg.Tile.config,"velocitySuppressionLowerThreshold",1e-6,.009999),o.add(window.hg.Grid.config,"tileMass",.1,10).onChange(function(o){a.grid.updateTileMass(o)})}},{name:"Input",isOpen:!1,createItems:function(o){o.add(window.hg.Input.config,"contentTileClickAnimation",Object.keys(window.hg.Input.config.possibleClickAnimations)),o.add(window.hg.Input.config,"emptyTileClickAnimation",Object.keys(window.hg.Input.config.possibleClickAnimations))}}],i.defaultPreSet="gold-scale",i.preSetConfigs={},i.preSetConfigs["gold-scale"]={Grid:{tileGap:4,backgroundHue:40,backgroundSaturation:15,backgroundLightness:3,tileHue:45,tileSaturation:10,tileLightness:7},TilePost:{inactiveScreenOpacity:.84,inactiveScreenHue:40,inactiveScreenSaturation:1,inactiveScreenLightness:1},LineJob:{lineWidth:4,startSaturation:100,startLightness:80,startOpacity:.3,endSaturation:100,endLightness:60,endOpacity:0,sameDirectionProb:.6},HighlightRadiateJob:{deltaSaturation:50,deltaLightness:20},HighlightHoverJob:{deltaSaturation:10,deltaLightness:20},ColorWaveJob:{deltaSaturation:20,deltaLightness:14,wavelength:4e3,period:4500,originY:2e3},ColorShiftJob:{hueDeltaMin:0,hueDeltaMax:0,saturationDeltaMin:-10,saturationDeltaMax:8,lightnessDeltaMin:-5,lightnessDeltaMax:5,imageBackgroundScreenOpacityDeltaMin:-.05,imageBackgroundScreenOpacityDeltaMax:.05,transitionDurationMin:800,transitionDurationMax:2e3},DisplacementWaveJob:{period:1e6,tileDeltaX:0,tileDeltaY:0},OpenPostJob:{fadePostDurationOffset:300},ClosePostJob:{duration:200}},i.preSetConfigs["stormy-sea"]={LineJob:{isRecurring:!0}},i.preSetConfigs["color-worms"]={Grid:{tileOuterRadius:50,tileHue:39,tileSaturation:49,tileLightness:12},Tile:{dragCoeff:.02,neighborSpringCoeff:4e-6,innerAnchorSpringCoeff:2e-5,borderAnchorSpringCoeff:2e-5},LineJob:{isRecurring:!0,lineWidth:12,lineLength:400,duration:7e4,lineSidePeriod:1e3,startSaturation:100,startLightness:60,startOpacity:.8,endSaturation:100,endLightness:60,endOpacity:0,sameDirectionProb:.75,avgDelay:2e3,delayDeviationRange:200},LinesRadiateJob:{lineWidth:7,lineLength:250,duration:3e4,lineSidePeriod:120,startSaturation:100,startLightness:60,startOpacity:.8,endSaturation:100,endLightness:60,endOpacity:0,sameDirectionProb:.75},DisplacementWaveJob:{period:1e6,tileDeltaX:0,tileDeltaY:0},ColorWaveJob:{period:1e6,deltaLightness:0},Input:{contentTileClickAnimation:"None",emptyTileClickAnimation:"Radiate Lines"},OpenPostJob:{expandedDisplacementTileCount:4}},i.preSetConfigs["crazy-flux"]={Grid:{tileOuterRadius:60,tileGap:40,tileHue:24,tileSaturation:75,tileLightness:50},LineJob:{isRecurring:!0,lineWidth:100,duration:3e3,startSaturation:100,startLightness:60,startOpacity:.7,endSaturation:100,endLightness:60,endOpacity:0,sameDirectionProb:.25,avgDelay:20,delayDeviationRange:10},Input:{contentTileClickAnimation:"None",emptyTileClickAnimation:"Radiate Lines"},DisplacementWaveJob:{period:1400,tileDeltaX:140,tileDeltaY:-120,originX:2e3,originY:1800},ColorShiftJob:{hueDeltaMin:-180,hueDeltaMax:180}},i.preSetConfigs["wire-frame"]={LineJob:{isRecurring:!0},Annotations:{annotations:{tileNeighborConnections:{enabled:!0},tileAnchorCenters:{enabled:!0},transparentTiles:{enabled:!0},lineAnimationGapPoints:{enabled:!0},lineAnimationCornerData:{enabled:!0},sectorAnchorCenters:{enabled:!0}}},Input:{contentTileClickAnimation:"None",emptyTileClickAnimation:"Radiate Lines"},DisplacementWaveJob:{originX:1600,originY:1800},Tile:{dragCoeff:.013,neighborSpringCoeff:2e-6,innerAnchorSpringCoeff:1e-5,borderAnchorSpringCoeff:2e-5}};var a={};a.init=function(o){a.grid=o},a.config=i,window.app=window.app||{},app.miscParams=a,console.log("miscellaneous-parameters module loaded")}(),function(){var i={},n={},e={};function a(){setTimeout(function(){(window.hg.controller.isSmallScreen?c:l)()},10)}function t(){i.gui=new dat.GUI,i.gui.close(),i.gui.width=n.datGuiWidth,window.gui=i.gui,(window.hg.controller.isSmallScreen?c:l)(),d(n.folders,i.gui)}function d(o,e){o.forEach(function(o){var n;"function"==typeof o?o(e):(n=e.addFolder(o.name),o.folder=n,o.isOpen&&n.open(),o.createItems&&o.createItems(n),o.children&&d(o.children,n))})}function r(o){o.forEach(function(o){"function"!=typeof o&&(o.isOpen=!o.folder.closed,o.children&&r(o.children))})}n.datGuiWidth=300,n.folders=[function(o){d(window.app.miscParams.config.folders,o)},{name:"Animations",isOpen:!1,createItems:null,children:[function(o){d(window.app.transientParams.config.folders,o)},function(o){d(window.app.persistentParams.config.folders,o)}]}],i.config=n,i.initDatGui=function(o){i.grid=o,e=Object.keys(window.hg).reduce(function(o,n){return window.hg[n].config&&(o[n]=window.hg.util.deepCopy(window.hg[n].config)),o},{}),window.app.miscParams.init(o),window.app.persistentParams.init(o),window.app.transientParams.init(o),t(),window.app.parameters.updateToPreSetConfigs.call(window.app.parameters,window.app.miscParams.config.preSetConfigs[window.app.miscParams.config.defaultPreSet]);o=window.hg.util.debounce(a,300);window.addEventListener("resize",o,!1),o()},i.updateForNewPostData=function(o){i.allCategories=function(o){var e=o.reduce(function(o,n){return n.categories.reduce(function(o,n){return o[n]=o[n]?o[n]+1:1,o},o)},{});return Object.keys(e).sort(function(o,n){return e[n]-e[o]})}(o),function(){function n(o,n,e){o[n]={},o[n][n]=!1,o[n].menuItem=e.add(o[n],n).onChange(function(){g(n)})}i.categoryData={},n(i.categoryData,"all",i.categoriesFolder),i.categoryData.all.all=!0,i.allCategories.forEach(function(o){n(i.categoryData,o,i.categoriesFolder)})}()},i.goHome=function(){console.log("Go Home clicked"),window.location.href="/"},i.hideMenu=c,i.updateToPreSetConfigs=function(o){console.log("Updating to pre-set configuration",o),r(n.folders),window.app.parameters.recordOpenChildFolders(window.app.miscParams.config.folders),window.app.parameters.recordOpenChildFolders(window.app.transientParams.config.folders),window.app.parameters.recordOpenChildFolders(window.app.persistentParams.config.folders),Object.keys(window.hg).forEach(function(n){window.hg[n].config&&Object.keys(e[n]).forEach(function(o){window.hg[n].config[o]=window.hg.util.deepCopy(e[n][o])})}),function(e){Object.keys(e).forEach(function(n){Object.keys(e[n]).forEach(function(o){!function n(e,i,a){"object"==typeof i[a]?Object.keys(i[a]).forEach(function(o){n(e[a],i[a],o)}):e[a]=i[a]}(window.hg[n].config,e[n],o)}),window.hg.controller.transientJobs[n]&&window.hg.controller.transientJobs[n].toggleRecurrence&&window.hg.controller.transientJobs[n].toggleRecurrence(i.grid,window.hg[n].config.isRecurring,window.hg[n].config.avgDelay,window.hg[n].config.delayDeviationRange)})}(o),i.grid.annotations.refresh(),window.hg.Grid.config.computeDependentValues(),window.hg.controller.resetGrid(i.grid),i.grid.setBackgroundColor(),i.grid.resize(),i.gui.destroy(),t()},i.filterPosts=g,i.recordOpenChildFolders=r,i.grid=null,i.gui=null,i.categoriesFolder=null,i.allCategories=[],i.categoryData={},window.app=window.app||{},app.parameters=i;var o=0;function g(n){o++,i.categoryData[n][n]?(Object.keys(i.categoryData).forEach(function(o){i.categoryData[o][o]&&o!==n&&i.categoryData[o].menuItem.setValue(!1)}),window.hg.controller.filterGridPostDataByCategory(i.grid,n)):1===o&&i.categoryData.all.menuItem.setValue(!0),o--}function c(){document.querySelector("body > .dg").style.display="none"}function l(){document.querySelector("body > .dg").style.display="block"}console.log("parameters module loaded")}(),function(){var o={folders:[{name:"Persistent",isOpen:!1,createItems:null,children:[{name:"Color Shift",isOpen:!1,createItems:function(o){o.add(window.hg.ColorShiftJob.config,"transitionDurationMin",1,1e4).onChange(function(o){window.hg.ColorShiftJob.config.transitionDurationMax=Math.max(window.hg.ColorShiftJob.config.transitionDurationMin,window.hg.ColorShiftJob.config.transitionDurationMax)}),o.add(window.hg.ColorShiftJob.config,"transitionDurationMax",1,1e4).onChange(function(o){window.hg.ColorShiftJob.config.transitionDurationMin=Math.min(window.hg.ColorShiftJob.config.transitionDurationMin,window.hg.ColorShiftJob.config.transitionDurationMax)}),o.add(window.hg.ColorShiftJob.config,"hueDeltaMin",-360,360).onChange(function(o){window.hg.ColorShiftJob.config.hueDeltaMax=Math.max(window.hg.ColorShiftJob.config.hueDeltaMin,window.hg.ColorShiftJob.config.hueDeltaMax)}),o.add(window.hg.ColorShiftJob.config,"hueDeltaMax",-360,360).onChange(function(o){window.hg.ColorShiftJob.config.hueDeltaMin=Math.min(window.hg.ColorShiftJob.config.hueDeltaMin,window.hg.ColorShiftJob.config.hueDeltaMax)}),o.add(window.hg.ColorShiftJob.config,"saturationDeltaMin",-100,100).onChange(function(o){window.hg.ColorShiftJob.config.saturationDeltaMax=Math.max(window.hg.ColorShiftJob.config.saturationDeltaMin,window.hg.ColorShiftJob.config.saturationDeltaMax)}),o.add(window.hg.ColorShiftJob.config,"saturationDeltaMax",-100,100).onChange(function(o){window.hg.ColorShiftJob.config.saturationDeltaMin=Math.min(window.hg.ColorShiftJob.config.saturationDeltaMin,window.hg.ColorShiftJob.config.saturationDeltaMax)}),o.add(window.hg.ColorShiftJob.config,"lightnessDeltaMin",-100,100).onChange(function(o){window.hg.ColorShiftJob.config.lightnessDeltaMax=Math.max(window.hg.ColorShiftJob.config.lightnessDeltaMin,window.hg.ColorShiftJob.config.lightnessDeltaMax)}),o.add(window.hg.ColorShiftJob.config,"lightnessDeltaMax",-100,100).onChange(function(o){window.hg.ColorShiftJob.config.lightnessDeltaMin=Math.min(window.hg.ColorShiftJob.config.lightnessDeltaMin,window.hg.ColorShiftJob.config.lightnessDeltaMax)}),o.add(window.hg.ColorShiftJob.config,"imageBackgroundScreenOpacityDeltaMin",-1,1).onChange(function(o){window.hg.ColorShiftJob.config.imageBackgroundScreenOpacityDeltaMax=Math.max(window.hg.ColorShiftJob.config.imageBackgroundScreenOpacityDeltaMin,window.hg.ColorShiftJob.config.imageBackgroundScreenOpacityDeltaMax)}),o.add(window.hg.ColorShiftJob.config,"imageBackgroundScreenOpacityDeltaMax",-1,1).onChange(function(o){window.hg.ColorShiftJob.config.imageBackgroundScreenOpacityDeltaMin=Math.min(window.hg.ColorShiftJob.config.imageBackgroundScreenOpacityDeltaMin,window.hg.ColorShiftJob.config.imageBackgroundScreenOpacityDeltaMax)})}},{name:"Color Wave",isOpen:!1,createItems:function(o){o.add(window.hg.ColorWaveJob.config,"period",1,1e4).onChange(function(o){window.hg.ColorWaveJob.config.halfPeriod=o/2}),o.add(window.hg.ColorWaveJob.config,"wavelength",1,4e3).onChange(function(){window.hg.controller.persistentJobs.ColorWaveJob.start(n.grid)}),o.add(window.hg.ColorWaveJob.config,"originX",-500,3e3).onChange(function(){window.hg.controller.persistentJobs.ColorWaveJob.start(n.grid)}),o.add(window.hg.ColorWaveJob.config,"originY",-500,3e3).onChange(function(){window.hg.controller.persistentJobs.ColorWaveJob.start(n.grid)}),o.add(window.hg.ColorWaveJob.config,"deltaHue",0,360),o.add(window.hg.ColorWaveJob.config,"deltaSaturation",0,100),o.add(window.hg.ColorWaveJob.config,"deltaLightness",0,100),o.add(window.hg.ColorWaveJob.config,"opacity",0,1)}},{name:"Displacement Wave",isOpen:!1,createItems:function(o){o.add(window.hg.DisplacementWaveJob.config,"period",1,1e4).onChange(function(o){window.hg.DisplacementWaveJob.config.halfPeriod=o/2}),o.add(window.hg.DisplacementWaveJob.config,"wavelength",1,4e3).onChange(function(){window.hg.controller.persistentJobs.DisplacementWaveJob.start(n.grid)}),o.add(window.hg.DisplacementWaveJob.config,"originX",-500,3e3).onChange(function(){window.hg.controller.persistentJobs.DisplacementWaveJob.start(n.grid)}),o.add(window.hg.DisplacementWaveJob.config,"originY",-500,3e3).onChange(function(){window.hg.controller.persistentJobs.DisplacementWaveJob.start(n.grid)}),o.add(window.hg.DisplacementWaveJob.config,"tileDeltaX",-300,300),o.add(window.hg.DisplacementWaveJob.config,"tileDeltaY",-300,300)}}]}]},n={};n.init=function(o){n.grid=o},n.config=o,window.app=window.app||{},app.persistentParams=n,console.log("persistent-animation-parameters module loaded")}(),function(){var o={folders:[{name:"Transient",isOpen:!1,createItems:null,children:[{name:"Open/Close Post",isOpen:!1,createItems:function(o){var n={triggerOpenPost:window.hg.controller.transientJobs.OpenPostJob.createRandom.bind(window.hg.controller,a.grid),triggerClosePost:window.hg.controller.transientJobs.ClosePostJob.createRandom.bind(window.hg.controller,a.grid,!1),triggerTogglePost:function(){a.grid.isPostOpen?n.triggerClosePost():n.triggerOpenPost()}};o.add(n,"triggerTogglePost"),o.add(window.hg.OpenPostJob.config,"duration",10,1e4).name("Open Duration"),o.add(window.hg.ClosePostJob.config,"duration",10,1e4).name("Close Duration"),o.add(window.hg.OpenPostJob.config,"expandedDisplacementTileCount",0,5).step(1)}},{name:"Displacement Radiate",isOpen:!1,createItems:function(o){var n={triggerDisplacement:window.hg.controller.transientJobs.DisplacementRadiateJob.createRandom.bind(window.hg.controller,a.grid)};function e(){window.hg.controller.transientJobs.DisplacementRadiateJob.toggleRecurrence(a.grid,window.hg.DisplacementRadiateJob.config.isRecurring,window.hg.DisplacementRadiateJob.config.avgDelay,window.hg.DisplacementRadiateJob.config.delayDeviationRange)}o.add(n,"triggerDisplacement"),o.add(window.hg.DisplacementRadiateJob.config,"duration",10,1e4),o.add(window.hg.DisplacementRadiateJob.config,"isRecurring").onChange(e),o.add(window.hg.DisplacementRadiateJob.config,"avgDelay",10,1e4).onChange(e),o.add(window.hg.DisplacementRadiateJob.config,"delayDeviationRange",0,1e4).onChange(e)}},{name:"Hover Highlight",isOpen:!1,createItems:function(o){var n,e;function i(){window.hg.controller.transientJobs.HighlightHoverJob.toggleRecurrence(a.grid,window.hg.HighlightHoverJob.config.isRecurring,window.hg.HighlightHoverJob.config.avgDelay,window.hg.HighlightHoverJob.config.delayDeviationRange)}(e=[]).deltaColor=window.hg.util.hslToHsv({h:window.hg.HighlightHoverJob.config.deltaHue,s:.01*window.hg.HighlightHoverJob.config.deltaSaturation,l:.01*window.hg.HighlightHoverJob.config.deltaLightness}),n={triggerHighlightHover:window.hg.controller.transientJobs.HighlightHoverJob.createRandom.bind(window.hg.controller,a.grid)},o.add(n,"triggerHighlightHover"),o.add(window.hg.HighlightHoverJob.config,"duration",10,1e4),o.addColor(e,"deltaColor").onChange(function(){var o=window.hg.util.hsvToHsl(e.deltaColor);window.hg.HighlightHoverJob.config.deltaHue=o.h,window.hg.HighlightHoverJob.config.deltaSaturation=100*o.s,window.hg.HighlightHoverJob.config.deltaLightness=100*o.l}),o.add(window.hg.HighlightHoverJob.config,"opacity",0,1),o.add(window.hg.HighlightHoverJob.config,"isRecurring").onChange(i),o.add(window.hg.HighlightHoverJob.config,"avgDelay",10,2e3).onChange(i),o.add(window.hg.HighlightHoverJob.config,"delayDeviationRange",0,2e3).onChange(i)}},{name:"Radiating Highlight",isOpen:!1,createItems:function(o){var n,e;function i(){window.hg.controller.transientJobs.HighlightRadiateJob.toggleRecurrence(a.grid,window.hg.HighlightRadiateJob.config.isRecurring,window.hg.HighlightRadiateJob.config.avgDelay,window.hg.HighlightRadiateJob.config.delayDeviationRange)}(e=[]).deltaColor=window.hg.util.hslToHsv({h:window.hg.HighlightRadiateJob.config.deltaHue,s:.01*window.hg.HighlightRadiateJob.config.deltaSaturation,l:.01*window.hg.HighlightRadiateJob.config.deltaLightness}),n={triggerHighlightRadiate:window.hg.controller.transientJobs.HighlightRadiateJob.createRandom.bind(window.hg.controller,a.grid)},o.add(n,"triggerHighlightRadiate"),o.add(window.hg.HighlightRadiateJob.config,"shimmerSpeed",.1,10),o.add(window.hg.HighlightRadiateJob.config,"shimmerWaveWidth",1,2e3),o.add(window.hg.HighlightRadiateJob.config,"duration",10,1e4),o.addColor(e,"deltaColor").onChange(function(){var o=window.hg.util.hsvToHsl(e.deltaColor);window.hg.HighlightRadiateJob.config.deltaHue=o.h,window.hg.HighlightRadiateJob.config.deltaSaturation=100*o.s,window.hg.HighlightRadiateJob.config.deltaLightness=100*o.l}),o.add(window.hg.HighlightRadiateJob.config,"opacity",0,1),o.add(window.hg.HighlightRadiateJob.config,"isRecurring").onChange(i),o.add(window.hg.HighlightRadiateJob.config,"avgDelay",10,1e4).onChange(i),o.add(window.hg.HighlightRadiateJob.config,"delayDeviationRange",0,1e4).onChange(i)}},{name:"Intra-Tile Radiate",isOpen:!1,createItems:function(o){var n={triggerIntraTileRadiate:window.hg.controller.transientJobs.IntraTileRadiateJob.createRandom.bind(window.hg.controller,a.grid)};function e(){window.hg.controller.transientJobs.IntraTileRadiateJob.toggleRecurrence(a.grid,window.hg.IntraTileRadiateJob.config.isRecurring,window.hg.IntraTileRadiateJob.config.avgDelay,window.hg.IntraTileRadiateJob.config.delayDeviationRange)}o.add(n,"triggerIntraTileRadiate"),o.add(window.hg.IntraTileRadiateJob.config,"duration",10,1e4),o.add(window.hg.IntraTileRadiateJob.config,"isRecurring").onChange(e),o.add(window.hg.IntraTileRadiateJob.config,"avgDelay",10,1e4).onChange(e),o.add(window.hg.IntraTileRadiateJob.config,"delayDeviationRange",0,1e4).onChange(e)}},{name:"Random Lines",isOpen:!1,createItems:function(o){var n={triggerLine:window.hg.controller.transientJobs.LineJob.createRandom.bind(window.hg.controller,a.grid)};function e(){window.hg.controller.transientJobs.LineJob.toggleRecurrence(a.grid,window.hg.LineJob.config.isRecurring,window.hg.LineJob.config.avgDelay,window.hg.LineJob.config.delayDeviationRange)}o.add(n,"triggerLine"),o.add(window.hg.LineJob.config,"duration",100,2e4),o.add(window.hg.LineJob.config,"lineWidth",1,100),o.add(window.hg.LineJob.config,"lineLength",10,6e4),o.add(window.hg.LineJob.config,"lineSidePeriod",5,500),o.add(window.hg.LineJob.config,"startSaturation",0,100),o.add(window.hg.LineJob.config,"startLightness",0,100),o.add(window.hg.LineJob.config,"startOpacity",0,1),o.add(window.hg.LineJob.config,"endSaturation",0,100),o.add(window.hg.LineJob.config,"endLightness",0,100),o.add(window.hg.LineJob.config,"endOpacity",0,1),o.add(window.hg.LineJob.config,"sameDirectionProb",0,1),o.add(window.hg.LineJob.config,"isBlurOn"),o.add(window.hg.LineJob.config,"blurStdDeviation",0,80),o.add(window.hg.LineJob.config,"isRecurring").onChange(e),o.add(window.hg.LineJob.config,"avgDelay",10,1e4).onChange(e),o.add(window.hg.LineJob.config,"delayDeviationRange",0,1e4).onChange(e)}},{name:"Radiating Lines",isOpen:!1,createItems:function(o){var n={triggerLinesRadiate:window.hg.controller.transientJobs.LinesRadiateJob.createRandom.bind(window.hg.controller,a.grid)};function e(){window.hg.controller.transientJobs.LinesRadiateJob.toggleRecurrence(a.grid,window.hg.LinesRadiateJob.config.isRecurring,window.hg.LinesRadiateJob.config.avgDelay,window.hg.LinesRadiateJob.config.delayDeviationRange)}o.add(n,"triggerLinesRadiate"),o.add(window.hg.LinesRadiateJob.config,"duration",100,2e4),o.add(window.hg.LinesRadiateJob.config,"lineWidth",1,100),o.add(window.hg.LinesRadiateJob.config,"lineLength",10,6e4),o.add(window.hg.LinesRadiateJob.config,"lineSidePeriod",5,500),o.add(window.hg.LinesRadiateJob.config,"startSaturation",0,100),o.add(window.hg.LinesRadiateJob.config,"startLightness",0,100),o.add(window.hg.LinesRadiateJob.config,"startOpacity",0,1),o.add(window.hg.LinesRadiateJob.config,"endSaturation",0,100),o.add(window.hg.LinesRadiateJob.config,"endLightness",0,100),o.add(window.hg.LinesRadiateJob.config,"endOpacity",0,1),o.add(window.hg.LinesRadiateJob.config,"sameDirectionProb",0,1),o.add(window.hg.LinesRadiateJob.config,"isBlurOn"),o.add(window.hg.LinesRadiateJob.config,"blurStdDeviation",0,80),o.add(window.hg.LinesRadiateJob.config,"isRecurring").onChange(e),o.add(window.hg.LinesRadiateJob.config,"avgDelay",10,1e4).onChange(e),o.add(window.hg.LinesRadiateJob.config,"delayDeviationRange",0,1e4).onChange(e)}},{name:"Pan",isOpen:!1,createItems:function(o){var n={triggerPan:window.hg.controller.transientJobs.PanJob.createRandom.bind(window.hg.controller,a.grid)};function e(){window.hg.controller.transientJobs.PanJob.toggleRecurrence(a.grid,window.hg.PanJob.config.isRecurring,window.hg.PanJob.config.avgDelay,window.hg.PanJob.config.delayDeviationRange)}o.add(n,"triggerPan"),o.add(window.hg.PanJob.config,"duration",10,1e4),o.add(window.hg.PanJob.config,"isRecurring").onChange(e),o.add(window.hg.PanJob.config,"avgDelay",10,1e4).onChange(e),o.add(window.hg.PanJob.config,"delayDeviationRange",0,1e4).onChange(e)}},{name:"Spread",isOpen:!1,createItems:function(o){var n={triggerSpread:window.hg.controller.transientJobs.SpreadJob.createRandom.bind(window.hg.controller,a.grid)};function e(){window.hg.controller.transientJobs.SpreadJob.toggleRecurrence(a.grid,window.hg.SpreadJob.config.isRecurring,window.hg.SpreadJob.config.avgDelay,window.hg.SpreadJob.config.delayDeviationRange)}o.add(n,"triggerSpread"),o.add(window.hg.SpreadJob.config,"duration",10,1e4),o.add(window.hg.SpreadJob.config,"displacementRatio",.01,1),o.add(window.hg.SpreadJob.config,"isRecurring").onChange(e),o.add(window.hg.SpreadJob.config,"avgDelay",10,1e4).onChange(e),o.add(window.hg.SpreadJob.config,"delayDeviationRange",0,1e4).onChange(e)}},{name:"Tile Border",isOpen:!1,createItems:function(o){var n={triggerTileBorder:window.hg.controller.transientJobs.TileBorderJob.createRandom.bind(window.hg.controller,a.grid)};function e(){window.hg.controller.transientJobs.TileBorderJob.toggleRecurrence(a.grid,window.hg.TileBorderJob.config.isRecurring,window.hg.TileBorderJob.config.avgDelay,window.hg.TileBorderJob.config.delayDeviationRange)}o.add(n,"triggerTileBorder"),o.add(window.hg.TileBorderJob.config,"duration",10,1e4),o.add(window.hg.TileBorderJob.config,"isRecurring").onChange(e),o.add(window.hg.TileBorderJob.config,"avgDelay",10,1e4).onChange(e),o.add(window.hg.TileBorderJob.config,"delayDeviationRange",0,1e4).onChange(e)}}]}]},a={};a.init=function(o){a.grid=o},a.config=o,window.app=window.app||{},app.transientParams=a,console.log("transient-animation-parameters module loaded")}();